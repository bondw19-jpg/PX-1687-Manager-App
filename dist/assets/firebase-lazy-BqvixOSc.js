 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const cu=[];var Y;(function(n){n[n.DEBUG=0]="DEBUG",n[n.VERBOSE=1]="VERBOSE",n[n.INFO=2]="INFO",n[n.WARN=3]="WARN",n[n.ERROR=4]="ERROR",n[n.SILENT=5]="SILENT"})(Y||(Y={}));const Xf={debug:Y.DEBUG,verbose:Y.VERBOSE,info:Y.INFO,warn:Y.WARN,error:Y.ERROR,silent:Y.SILENT},zI=Y.INFO,GI={[Y.DEBUG]:"log",[Y.VERBOSE]:"log",[Y.INFO]:"info",[Y.WARN]:"warn",[Y.ERROR]:"error"},$I=(n,e,...t)=>{if(e<n.logLevel)return;const r=new Date().toISOString(),i=GI[e];if(i)console[i](`[${r}]  ${n.name}:`,...t);else throw new Error(`Attempted to log a message with an invalid logType (value: ${e})`)};class uu{constructor(e){this.name=e,this._logLevel=zI,this._logHandler=$I,this._userLogHandler=null,cu.push(this)}get logLevel(){return this._logLevel}set logLevel(e){if(!(e in Y))throw new TypeError(`Invalid value "${e}" assigned to \`logLevel\``);this._logLevel=e}setLogLevel(e){this._logLevel=typeof e=="string"?Xf[e]:e}get logHandler(){return this._logHandler}set logHandler(e){if(typeof e!="function")throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=e}get userLogHandler(){return this._userLogHandler}set userLogHandler(e){this._userLogHandler=e}debug(...e){this._userLogHandler&&this._userLogHandler(this,Y.DEBUG,...e),this._logHandler(this,Y.DEBUG,...e)}log(...e){this._userLogHandler&&this._userLogHandler(this,Y.VERBOSE,...e),this._logHandler(this,Y.VERBOSE,...e)}info(...e){this._userLogHandler&&this._userLogHandler(this,Y.INFO,...e),this._logHandler(this,Y.INFO,...e)}warn(...e){this._userLogHandler&&this._userLogHandler(this,Y.WARN,...e),this._logHandler(this,Y.WARN,...e)}error(...e){this._userLogHandler&&this._userLogHandler(this,Y.ERROR,...e),this._logHandler(this,Y.ERROR,...e)}}function KI(n){cu.forEach(e=>{e.setLogLevel(n)})}function HI(n,e){for(const t of cu){let r=null;e&&e.level&&(r=Xf[e.level]),n===null?t.userLogHandler=null:t.userLogHandler=(i,s,...o)=>{const c=o.map(u=>{if(u==null)return null;if(typeof u=="string")return u;if(typeof u=="number"||typeof u=="boolean")return u.toString();if(u instanceof Error)return u.message;try{return JSON.stringify(u)}catch{return null}}).filter(u=>u).join(" ");s>=(r??i.logLevel)&&n({level:Y[s].toLowerCase(),message:c,args:o,type:i.name})}}}const WI=(n,e)=>e.some(t=>n instanceof t);let zh,Gh;function QI(){return zh||(zh=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function JI(){return Gh||(Gh=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const Zf=new WeakMap,Dc=new WeakMap,ep=new WeakMap,dc=new WeakMap,lu=new WeakMap;function YI(n){const e=new Promise((t,r)=>{const i=()=>{n.removeEventListener("success",s),n.removeEventListener("error",o)},s=()=>{t(ln(n.result)),i()},o=()=>{r(n.error),i()};n.addEventListener("success",s),n.addEventListener("error",o)});return e.then(t=>{t instanceof IDBCursor&&Zf.set(t,n)}).catch(()=>{}),lu.set(e,n),e}function XI(n){if(Dc.has(n))return;const e=new Promise((t,r)=>{const i=()=>{n.removeEventListener("complete",s),n.removeEventListener("error",o),n.removeEventListener("abort",o)},s=()=>{t(),i()},o=()=>{r(n.error||new DOMException("AbortError","AbortError")),i()};n.addEventListener("complete",s),n.addEventListener("error",o),n.addEventListener("abort",o)});Dc.set(n,e)}let kc={get(n,e,t){if(n instanceof IDBTransaction){if(e==="done")return Dc.get(n);if(e==="objectStoreNames")return n.objectStoreNames||ep.get(n);if(e==="store")return t.objectStoreNames[1]?void 0:t.objectStore(t.objectStoreNames[0])}return ln(n[e])},set(n,e,t){return n[e]=t,!0},has(n,e){return n instanceof IDBTransaction&&(e==="done"||e==="store")?!0:e in n}};function ZI(n){kc=n(kc)}function eT(n){return n===IDBDatabase.prototype.transaction&&!("objectStoreNames"in IDBTransaction.prototype)?function(e,...t){const r=n.call(fc(this),e,...t);return ep.set(r,e.sort?e.sort():[e]),ln(r)}:JI().includes(n)?function(...e){return n.apply(fc(this),e),ln(Zf.get(this))}:function(...e){return ln(n.apply(fc(this),e))}}function tT(n){return typeof n=="function"?eT(n):(n instanceof IDBTransaction&&XI(n),WI(n,QI())?new Proxy(n,kc):n)}function ln(n){if(n instanceof IDBRequest)return YI(n);if(dc.has(n))return dc.get(n);const e=tT(n);return e!==n&&(dc.set(n,e),lu.set(e,n)),e}const fc=n=>lu.get(n);function nT(n,e,{blocked:t,upgrade:r,blocking:i,terminated:s}={}){const o=indexedDB.open(n,e),c=ln(o);return r&&o.addEventListener("upgradeneeded",u=>{r(ln(o.result),u.oldVersion,u.newVersion,ln(o.transaction),u)}),t&&o.addEventListener("blocked",u=>t(u.oldVersion,u.newVersion,u)),c.then(u=>{s&&u.addEventListener("close",()=>s()),i&&u.addEventListener("versionchange",l=>i(l.oldVersion,l.newVersion,l))}).catch(()=>{}),c}const rT=["get","getKey","getAll","getAllKeys","count"],iT=["put","add","delete","clear"],pc=new Map;function $h(n,e){if(!(n instanceof IDBDatabase&&!(e in n)&&typeof e=="string"))return;if(pc.get(e))return pc.get(e);const t=e.replace(/FromIndex$/,""),r=e!==t,i=iT.includes(t);if(!(t in(r?IDBIndex:IDBObjectStore).prototype)||!(i||rT.includes(t)))return;const s=async function(o,...c){const u=this.transaction(o,i?"readwrite":"readonly");let l=u.store;return r&&(l=l.index(c.shift())),(await Promise.all([l[t](...c),i&&u.done]))[0]};return pc.set(e,s),s}ZI(n=>({...n,get:(e,t,r)=>$h(e,t)||n.get(e,t,r),has:(e,t)=>!!$h(e,t)||n.has(e,t)}));/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sT{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(t=>{if(oT(t)){const r=t.getImmediate();return`${r.library}/${r.version}`}else return null}).filter(t=>t).join(" ")}}function oT(n){const e=n.getComponent();return(e==null?void 0:e.type)==="VERSION"}const Mo="@firebase/app",Nc="0.10.13";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const zT="firebase-heartbeat-database",GT=1,is="firebase-heartbeat-store";let mc=null;function op(){return mc||(mc=nT(zT,GT,{upgrade:(n,e)=>{switch(e){case 0:try{n.createObjectStore(is)}catch(t){console.warn(t)}}}}).catch(n=>{throw at.create("idb-open",{originalErrorMessage:n.message})})),mc}async function $T(n){try{const t=(await op()).transaction(is),r=await t.objectStore(is).get(ap(n));return await t.done,r}catch(e){if(e instanceof mt)Ft.warn(e.message);else{const t=at.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});Ft.warn(t.message)}}}async function Kh(n,e){try{const r=(await op()).transaction(is,"readwrite");await r.objectStore(is).put(e,ap(n)),await r.done}catch(t){if(t instanceof mt)Ft.warn(t.message);else{const r=at.create("idb-set",{originalErrorMessage:t==null?void 0:t.message});Ft.warn(r.message)}}}function ap(n){return`${n.name}!${n.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function YT(n){mn(new fn("platform-logger",e=>new sT(e),"PRIVATE")),mn(new fn("heartbeat",e=>new WT(e),"PRIVATE")),ct(Mo,Nc,n),ct(Mo,Nc,"esm2017"),ct("fire-js","")}YT("");var Qh=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
...
`}),h}function oc(a,h,f){e:{for(m in f){var m=!1;break e}m=!0}m||(f=yh(f),typeof a=="string"?f!=null&&encodeURIComponent(String(f)):ue(a,h,f))}function Te(a){Be.call(this),this.headers=new Map,this.o=a||null,this.h=!1,this.v=this.g=null,this.D="",this.m=0,this.l="",this.j=this.B=this.u=this.A=!1,this.I=null,this.H="",this.J=!1}S(Te,Be);var Ky=/^https?$/i,Hy=["POST","PUT"];n=Te.prototype,n.Ha=function(a){this.J=a},n.ea=function(a,h,f,m){if(this.g)throw Error("[goog.net.XhrIo] Object is active with another request="+this.D+"; newUri="+a);h=h?h.toUpperCase():"GET",this.D=a,this.l="",this.m=0,this.A=!1,this.h=!0,this.g=this.o?this.o.g():Za.g(),this.v=this.o?Hl(this.o):Hl(Za),this.g.onreadystatechange=g(this.Ea,this);try{this.B=!0,this.g.open(h,String(a),!0),this.B=!1}catch(D){Ih(this,D);return}if(a=f||"",f=new Map(this.headers),m)if(Object.getPrototypeOf(m)===Object.prototype)for(var R in m)f.set(R,m[R]);else if(typeof m.keys=="function"&&typeof m.get=="function")for(const D of m.keys())f.set(D,m.get(D));else throw Error("Unknown input type for opt_headers: "+String(m));m=Array.from(f.keys()).find(D=>D.toLowerCase()=="content-type"),R=c.FormData&&a instanceof c.FormData,!(0<=Array.prototype.indexOf.call(Hy,h,void 0))||m||R||f.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");for(const[D,F]of f)this.g.setRequestHeader(D,F);this.H&&(this.g.responseType=this.H),"withCredentials"in this.g&&this.g.withCredentials!==this.J&&(this.g.withCredentials=this.J);try{vh(this),this.u=!0,this.g.send(a),this.u=!1}catch(D){Ih(this,D)}};function Ih(a,h){a.h=!1,a.g&&(a.j=!0,a.g.abort(),a.j=!1),a.l=h,a.m=5,Th(a),to(a)}function Th(a){a.A||(a.A=!0,We(a,"complete"),We(a,"error"))}n.abort=function(a){this.g&&this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1,this.m=a||7,We(this,"complete"),We(this,"abort"),to(this))},n.N=function(){this.g&&(this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1),to(this,!0)),Te.aa.N.call(this)},n.Ea=function(){this.s||(this.B||this.u||this.j?Eh(this):this.bb())},n.bb=function(){Eh(this)};function Eh(a){if(a.h&&typeof o<"u"&&(!a.v[1]||Pt(a)!=4||a.Z()!=2)){if(a.u&&Pt(a)==4)zl(a.Ea,0,a);else if(We(a,"readystatechange"),Pt(a)==4){a.h=!1;try{const F=a.Z();e:switch(F){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:var h=!0;break e;default:h=!1}var f;if(!(f=h)){var m;if(m=F===0){var R=String(a.D).match(hh)[1]||null;!R&&c.self&&c.self.location&&(R=c.self.location.protocol.slice(0,-1)),m=!Ky.test(R?R.toLowerCase():"")}f=m}if(f)We(a,"complete"),We(a,"success");else{a.m=6;try{var D=2<Pt(a)?a.g.statusText:""}catch{D=""}a.l=D+" ["+a.Z()+"]",Th(a)}}finally{to(a)}}}}function to(a,h){if(a.g){vh(a);const f=a.g,m=a.v[0]?()=>{}:null;a.g=null,a.v=null,h||We(a,"ready");try{f.onreadystatechange=m}catch{}}}function vh(a){a.I&&(c.clearTimeout(a.I),a.I=null)}n.isActive=function(){return!!this.g};function Pt(a){return a.g?a.g.readyState:0}n.Z=function(){try{return 2<Pt(this)?this.g.status:-1}catch{return-1}},n.oa=function(){try{return this.g?this.g.responseText:""}catch{return""}},n.Oa=function(a){if(this.g){var h=this.g.responseText;return a&&h.indexOf(a)==0&&(h=h.substring(a.length)),Ry(h)}};function wh(a){try{if(!a.g)return null;if("response"in a.g)return a.g.response;switch(a.H){case"":case"text":return a.g.responseText;case"arraybuffer":if("mozResponseArrayBuffer"in a.g)return a.g.mozResponseArrayBuffer}return null}catch{return null}}function Wy(a){const h={};a=(a.g&&2<=Pt(a)&&a.g.getAllResponseHeaders()||"").split(`\r
`);for(let m=0;m<a.length;m++){if(M(a[m]))continue;var f=w(a[m]);const R=f[0];if(f=f[1],typeof f!="string")continue;f=f.trim();const D=h[R]||[];h[R]=D,D.push(f)}E(h,function(m){return m.join(", ")})}n.Ba=function(){return this.m},n.Ka=function(){return typeof this.l=="string"?this.l:String(this.l)};function Pi(a,h,f){return f&&f.internalChannelParams&&f.internalChannelParams[a]||h}function Ah(a){this.Aa=0,this.i=[],this.j=new Ei,this.ia=this.qa=this.I=this.W=this.g=this.ya=this.D=this.H=this.m=this.S=this.o=null,this.Ya=this.U=0,this.Va=Pi("failFast",!1,a),this.F=this.C=this.u=this.s=this.l=null,this.X=!0,this.za=this.T=-1,this.Y=this.v=this.B=0,this.Ta=Pi("baseRetryDelayMs",5e3,a),this.cb=Pi("retryDelaySeedMs",1e4,a),this.Wa=Pi("forwardChannelMaxRetries",2,a),this.wa=Pi("forwardChannelRequestTimeoutMs",2e4,a),this.pa=a&&a.xmlHttpFactory||void 0,this.Xa=a&&a.Tb||void 0,this.Ca=a&&a.useFetchStreams||!1,this.L=void 0,this.J=a&&a.supportsCrossDomainXhr||!1,this.K="",this.h=new sh(a&&a.concurrentRequestLimit),this.Da=new Gy,this.P=a&&a.fastHandshake||!1,this.O=a&&a.encodeInitMessageHeaders||!1,this.P&&this.O&&(this.O=!1),this.Ua=a&&a.Rb||!1,a&&a.xa&&this.j.xa(),a&&a.forceLongPolling&&(this.X=!1),this.ba=!this.P&&this.X&&a&&a.detectBufferingProxy||!1,this.ja=void 0,a&&a.longPollingTimeout&&0<a.longPollingTimeout&&(this.ja=a.longPollingTimeout),this.ca=void 0,this.R=0,this.M=!1,this.ka=this.A=null}n=Ah.prototype,n.la=8,n.G=1,n.connect=function(a,h,f,m){Qe(0),this.W=a,this.H=h||{},f&&m!==void 0&&(this.H.OSID=f,this.H.OAID=m),this.F=this.X,this.I=Vh(this,null,this.W),ro(this)};function ac(a){if(Rh(a),a.G==3){var h=a.U++,f=St(a.I);if(ue(f,"SID",a.K),ue(f,"RID",h),ue(f,"TYPE","terminate"),Ci(a,f),h=new Yt(a,a.j,h),h.L=2,h.v=Xs(St(f)),f=!1,c.navigator&&c.navigator.sendBeacon)try{f=c.navigator.sendBeacon(h.v.toString(),"")}catch{}!f&&c.Image&&(new Image().src=h.v,f=!0),f||(h.g=Oh(h.j,null),h.g.ea(h.v)),h.F=Date.now(),Qs(h)}Nh(a)}function no(a){a.g&&(uc(a),a.g.cancel(),a.g=null)}function Rh(a){no(a),a.u&&(c.clearTimeout(a.u),a.u=null),io(a),a.h.cancel(),a.s&&(typeof a.s=="number"&&c.clearTimeout(a.s),a.s=null)}function ro(a){if(!oh(a.h)&&!a.s){a.s=!0;var h=a.Ga;pi||Fl(),mi||(pi(),mi=!0),qa.add(h,a),a.B=0}}function Qy(a,h){return ah(a.h)>=a.h.j-(a.s?1:0)?!1:a.s?(a.i=h.D.concat(a.i),!0):a.G==1||a.G==2||a.B>=(a.Va?0:a.Wa)?!1:(a.s=Ti(g(a.Ga,a,h),kh(a,a.B)),a.B++,!0)}n.Ga=function(a){if(this.s)if(this.s=null,this.G==1){if(!a){this.U=Math.floor(1e5*Math.random()),a=this.U++;const R=new Yt(this,this.j,a);let D=this.o;if(this.S&&(D?(D=_(D),v(D,this.S)):D=this.S),this.m!==null||this.O||(R.H=D,D=null),this.P)e:{for(var h=0,f=0;f<this.i.length;f++){t:{var m=this.i[f];if("__data__"in m.map&&(m=m.map.__data__,typeof m=="string")){m=m.length;break t}m=void 0}if(m===void 0)break;if(h+=m,4096<h){h=f;break e}if(h===4096||f===this.i.length-1){h=f+1;break e}}h=1e3}else h=1e3;h=Sh(this,R,h),f=St(this.I),ue(f,"RID",a),ue(f,"CVER",22),this.D&&ue(f,"X-HTTP-Session-Id",this.D),Ci(this,f),D&&(this.O?h="headers="+encodeURIComponent(String(yh(D)))+"&"+h:this.m&&oc(f,this.m,D)),sc(this.h,R),this.Ua&&ue(f,"TYPE","init"),this.P?(ue(f,"$req",h),ue(f,"SID","null"),R.T=!0,tc(R,f,null)):tc(R,f,h),this.G=2}}else this.G==3&&(a?bh(this,a):this.i.length==0||oh(this.h)||bh(this))};function bh(a,h){var f;h?f=h.l:f=a.U++;const m=St(a.I);ue(m,"SID",a.K),ue(m,"RID",f),ue(m,"AID",a.T),Ci(a,m),a.m&&a.o&&oc(m,a.m,a.o),f=new Yt(a,a.j,f,a.B+1),a.m===null&&(f.H=a.o),h&&(a.i=h.D.concat(a.i)),h=Sh(a,f,1e3),f.I=Math.round(.5*a.wa)+Math.round(.5*a.wa*Math.random()),sc(a.h,f),tc(f,m,h)}function Ci(a,h){a.H&&$(a.H,function(f,m){ue(h,m,f)}),a.l&&lh({},function(f,m){ue(h,m,f)})}function Sh(a,h,f){f=Math.min(a.i.length,f);var m=a.l?g(a.l.Na,a.l,a):null;e:{var R=a.i;let D=-1;for(;;){const F=["count="+f];D==-1?0<f?(D=R[0].g,F.push("ofs="+D)):D=0:F.push("ofs="+D);let oe=!0;for(let Le=0;Le<f;Le++){let te=R[Le].g;const qe=R[Le].map;if(te-=D,0>te)D=Math.max(0,R[Le].g-100),oe=!1;else try{$y(qe,F,"req"+te+"_")}catch{m&&m(qe)}}if(oe){m=F.join("&");break e}}}return a=a.i.splice(0,f),h.D=a,m}function Ph(a){if(!a.g&&!a.u){a.Y=1;var h=a.Fa;pi||Fl(),mi||(pi(),mi=!0),qa.add(h,a),a.v=0}}function cc(a){return a.g||a.u||3<=a.v?!1:(a.Y++,a.u=Ti(g(a.Fa,a),kh(a,a.v)),a.v++,!0)}n.Fa=function(){if(this.u=null,Ch(this),this.ba&&!(this.M||this.g==null||0>=this.R)){var a=2*this.R;this.j.info("BP detection timer enabled: "+a),this.A=Ti(g(this.ab,this),a)}},n.ab=function(){this.A&&(this.A=null,this.j.info("BP detection timeout reached."),this.j.info("Buffering proxy detected and switch to long-polling!"),this.F=!1,this.M=!0,Qe(10),no(this),Ch(this))};function uc(a){a.A!=null&&(c.clearTimeout(a.A),a.A=null)}function Ch(a){a.g=new Yt(a,a.j,"rpc",a.Y),a.m===null&&(a.g.H=a.o),a.g.O=0;var h=St(a.qa);ue(h,"RID","rpc"),ue(h,"SID",a.K),ue(h,"AID",a.T),ue(h,"CI",a.F?"0":"1"),!a.F&&a.ja&&ue(h,"TO",a.ja),ue(h,"TYPE","xmlhttp"),Ci(a,h),a.m&&a.o&&oc(h,a.m,a.o),a.L&&(a.g.I=a.L);var f=a.g;a=a.ia,f.L=1,f.v=Xs(St(h)),f.m=null,f.P=!0,nh(f,a)}n.Za=function(){this.C!=null&&(this.C=null,no(this),cc(this),Qe(19))};function io(a){a.C!=null&&(c.clearTimeout(a.C),a.C=null)}function Dh(a,h){var f=null;if(a.g==h){io(a),uc(a),a.g=null;var m=2}else if(ic(a.h,h))f=h.D,ch(a.h,h),m=1;else return;if(a.G!=0){if(h.o)if(m==1){f=h.m?h.m.length:0,h=Date.now()-h.F;var R=a.B;m=Ks(),We(m,new Xl(m,f)),ro(a)}else Ph(a);else if(R=h.s,R==3||R==0&&0<h.X||!(m==1&&Qy(a,h)||m==2&&cc(a)))switch(f&&0<f.length&&(h=a.h,h.i=h.i.concat(f)),R){case 1:Mn(a,5);break;case 4:Mn(a,10);break;case 3:Mn(a,6);break;default:Mn(a,2)}}}function kh(a,h){let f=a.Ta+Math.floor(Math.random()*a.cb);return a.isActive()||(f*=2),f*h}function Mn(a,h){if(a.j.info("Error code "+h),h==2){var f=g(a.fb,a),m=a.Xa;const R=!m;m=new Ln(m||"//www.google.com/images/cleardot.gif"),c.location&&c.location.protocol=="http"||Js(m,"https"),Xs(m),R?jy(m.toString(),f):zy(m.toString(),f)}else Qe(2);a.G=0,a.l&&a.l.sa(h),Nh(a),Rh(a)}n.fb=function(a){a?(this.j.info("Successfully pinged google.com"),Qe(2)):(this.j.info("Failed to ping google.com"),Qe(1))};function Nh(a){if(a.G=0,a.ka=[],a.l){const h=uh(a.h);(h.length!=0||a.i.length!=0)&&(C(a.ka,h),C(a.ka,a.i),a.h.i.length=0,k(a.i),a.i.length=0),a.l.ra()}}function Vh(a,h,f){var m=f instanceof Ln?St(f):new Ln(f);if(m.g!="")h&&(m.g=h+"."+m.g),Ys(m,m.s);else{var R=c.location;m=R.protocol,h=h?h+"."+R.hostname:R.hostname,R=+R.port;var D=new Ln(null);m&&Js(D,m),h&&(D.g=h),R&&Ys(D,R),f&&(D.l=f),m=D}return f=a.D,h=a.ya,f&&h&&ue(m,f,h),ue(m,"VER",a.la),Ci(a,m),m}function Oh(a,h,f){if(h&&!a.J)throw Error("Can't create secondary domain capable XhrIo object.");return h=a.Ca&&!a.pa?new Te(new Zs({eb:f})):new Te(a.pa),h.Ha(a.J),h}n.isActive=function(){return!!this.l&&this.l.isActive(this)};function xh(){}n=xh.prototype,n.ua=function(){},n.ta=function(){},n.sa=function(){},n.ra=function(){},n.isActive=function(){return!0},n.Na=function(){};function so(){}so.prototype.g=function(a,h){return new rt(a,h)};function rt(a,h){Be.call(this),this.g=new Ah(h),this.l=a,this.h=h&&h.messageUrlParams||null,a=h&&h.messageHeaders||null,h&&h.clientProtocolHeaderRequired&&(a?a["X-Client-Protocol"]="webchannel":a={"X-Client-Protocol":"webchannel"}),this.g.o=a,a=h&&h.initMessageHeaders||null,h&&h.messageContentType&&(a?a["X-WebChannel-Content-Type"]=h.messageContentType:a={"X-WebChannel-Content-Type":h.messageContentType}),h&&h.va&&(a?a["X-WebChannel-Client-Profile"]=h.va:a={"X-WebChannel-Client-Profile":h.va}),this.g.S=a,(a=h&&h.Sb)&&!M(a)&&(this.g.m=a),this.v=h&&h.supportsCrossDomainXhr||!1,this.u=h&&h.sendRawJson||!1,(h=h&&h.httpSessionIdParam)&&!M(h)&&(this.g.D=h,a=this.h,a!==null&&h in a&&(a=this.h,h in a&&delete a[h])),this.j=new pr(this)}S(rt,Be),rt.prototype.m=function(){this.g.l=this.j,this.v&&(this.g.J=!0),this.g.connect(this.l,this.h||void 0)},rt.prototype.close=function(){ac(this.g)},rt.prototype.o=function(a){var h=this.g;if(typeof a=="string"){var f={};f.__data__=a,a=f}else this.u&&(f={},f.__data__=Qa(a),a=f);h.i.push(new Ny(h.Ya++,a)),h.G==3&&ro(h)},rt.prototype.N=function(){this.g.l=null,delete this.j,ac(this.g),delete this.g,rt.aa.N.call(this)};function Lh(a){Ya.call(this),a.__headers__&&(this.headers=a.__headers__,this.statusCode=a.__status__,delete a.__headers__,delete a.__status__);var h=a.__sm__;if(h){e:{for(const f in h){a=f;break e}a=void 0}(this.i=a)&&(a=this.i,h=h!==null&&a in h?h[a]:void 0),this.data=h}else this.data=a}S(Lh,Ya);function Mh(){Xa.call(this),this.status=1}S(Mh,Xa);function pr(a){this.g=a}S(pr,xh),pr.prototype.ua=function(){We(this.g,"a")},pr.prototype.ta=function(a){We(this.g,new Lh(a))},pr.prototype.sa=function(a){We(this.g,new Mh)},pr.prototype.ra=function(){We(this.g,"b")},so.prototype.createWebChannel=so.prototype.g,rt.prototype.send=rt.prototype.o,rt.prototype.open=rt.prototype.m,rt.prototype.close=rt.prototype.close,fp=function(){return new so},dp=function(){return Ks()},hp=On,Oc={mb:0,pb:1,qb:2,Jb:3,Ob:4,Lb:5,Mb:6,Kb:7,Ib:8,Nb:9,PROXY:10,NOPROXY:11,Gb:12,Cb:13,Db:14,Bb:15,Eb:16,Fb:17,ib:18,hb:19,jb:20},Hs.NO_ERROR=0,Hs.TIMEOUT=8,Hs.HTTP_ERROR=6,vo=Hs,Zl.COMPLETE="complete",lp=Zl,Wl.EventType=yi,yi.OPEN="a",yi.CLOSE="b",yi.ERROR="c",yi.MESSAGE="d",Be.prototype.listen=Be.prototype.K,ji=Wl,Te.prototype.listenOnce=Te.prototype.L,Te.prototype.getLastError=Te.prototype.Ka,Te.prototype.getLastErrorCode=Te.prototype.Ba,Te.prototype.getStatus=Te.prototype.Z,Te.prototype.getResponseJson=Te.prototype.Oa,Te.prototype.getResponseText=Te.prototype.oa,Te.prototype.send=Te.prototype.ea,Te.prototype.setWithCredentials=Te.prototype.Ha,up=Te}).apply(typeof ao<"u"?ao:typeof self<"u"?self:typeof window<"u"?window:{});const Jh="@firebase/firestore";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const gn=new uu("@firebase/firestore");function vr(){return gn.logLevel}function XT(n){gn.setLogLevel(n)}function V(n,...e){if(gn.logLevel<=Y.DEBUG){const t=e.map(hu);gn.debug(`Firestore (${Jr}): ${n}`,...t)}}function Re(n,...e){if(gn.logLevel<=Y.ERROR){const t=e.map(hu);gn.error(`Firestore (${Jr}): ${n}`,...t)}}function it(n,...e){if(gn.logLevel<=Y.WARN){const t=e.map(hu);gn.warn(`Firestore (${Jr}): ${n}`,...t)}}function hu(n){if(typeof n=="string")return n;try{/**
* @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function j(n="Unexpected state"){const e=`FIRESTORE (${Jr}) INTERNAL ASSERTION FAILED: `+n;throw Re(e),new Error(e)}function z(n,e){n||j()}function ZT(n,e){n||j()}function L(n,e){return n}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Or{constructor(e,t,r,i){this.indexId=e,this.collectionGroup=t,this.fields=r,this.indexState=i}}function xc(n){return n.fields.find(e=>e.kind===2)}function Bn(n){return n.fields.filter(e=>e.kind!==2)}function cE(n,e){let t=H(n.collectionGroup,e.collectionGroup);if(t!==0)return t;for(let r=0;r<Math.min(n.fields.length,e.fields.length);++r)if(t=uE(n.fields[r],e.fields[r]),t!==0)return t;return H(n.fields.length,e.fields.length)}Or.UNKNOWN_ID=-1;class Wn{constructor(e,t){this.fieldPath=e,this.kind=t}}function uE(n,e){const t=he.comparator(n.fieldPath,e.fieldPath);return t!==0?t:H(n.kind,e.kind)}class xr{constructor(e,t){this.sequenceNumber=e,this.offset=t}static empty(){return new xr(0,st.min())}}function yp(n,e){const t=n.toTimestamp().seconds,r=n.toTimestamp().nanoseconds+1,i=K.fromTimestamp(r===1e9?new ge(t+1,0):new ge(t,r));return new st(i,U.empty(),e)}function Ip(n){return new st(n.readTime,n.key,-1)}class st{constructor(e,t,r){this.readTime=e,this.documentKey=t,this.largestBatchId=r}static min(){return new st(K.min(),U.empty(),-1)}static max(){return new st(K.max(),U.empty(),-1)}}function fu(n,e){let t=n.readTime.compareTo(e.readTime);return t!==0?t:(t=U.comparator(n.documentKey,e.documentKey),t!==0?t:H(n.largestBatchId,e.largestBatchId))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Lc extends Ep{constructor(e,t){super(),this._e=e,this.currentSequenceNumber=t}}function De(n,e){const t=L(n);return Tt.F(t._e,e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ca(n){var e,t;return((t=(((e=n==null?void 0:n.mapValue)===null||e===void 0?void 0:e.fields)||{}).__type__)===null||t===void 0?void 0:t.stringValue)==="server_timestamp"}function ua(n){const e=n.mapValue.fields.__previous_value__;return ca(e)?ua(e):e}function as(n){const e=Ut(n.mapValue.fields.__local_write_time__.timestampValue);return new ge(e.seconds,e.nanos)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Tn{constructor(e,t){this.position=e,this.inclusive=t}}function cd(n,e,t){let r=0;for(let i=0;i<n.position.length;i++){const s=e[i],o=n.position[i];if(s.field.isKeyField()?r=U.comparator(U.fromName(o.referenceValue),t.key):r=In(o,t.data.field(s.field)),s.dir==="desc"&&(r*=-1),r!==0)break}return r}function ud(n,e){if(n===null)return e===null;if(e===null||n.inclusive!==e.inclusive||n.position.length!==e.position.length)return!1;for(let t=0;t<n.position.length;t++)if(!wt(n.position[t],e.position[t]))return!1;return!0}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $E{constructor(e,t=null,r=[],i=[],s=null,o=null,c=null){this.path=e,this.collectionGroup=t,this.orderBy=r,this.filters=i,this.limit=s,this.startAt=o,this.endAt=c,this.ue=null}}function qc(n,e=null,t=[],r=[],i=null,s=null,o=null){return new $E(n,e,t,r,i,s,o)}function Xn(n){const e=L(n);if(e.ue===null){let t=e.path.canonicalString();e.collectionGroup!==null&&(t+="|cg:"+e.collectionGroup),t+="|f:",t+=e.filters.map(r=>Bc(r)).join(","),t+="|ob:",t+=e.orderBy.map(r=>function(s){return s.field.canonicalString()+s.dir}(r)).join(","),Es(e.limit)||(t+="|l:",t+=e.limit),e.startAt&&(t+="|lb:",t+=e.startAt.inclusive?"b:":"a:",t+=e.startAt.position.map(r=>Lr(r)).join(",")),e.endAt&&(t+="|ub:",t+=e.endAt.inclusive?"a:":"b:",t+=e.endAt.position.map(r=>Lr(r)).join(",")),e.ue=t}return e.ue}function vs(n,e){if(n.limit!==e.limit||n.orderBy.length!==e.orderBy.length)return!1;for(let t=0;t<n.orderBy.length;t++)if(!FE(n.orderBy[t],e.orderBy[t]))return!1;if(n.filters.length!==e.filters.length)return!1;for(let t=0;t<n.filters.length;t++)if(!Lp(n.filters[t],e.filters[t]))return!1;return n.collectionGroup===e.collectionGroup&&!!n.path.isEqual(e.path)&&!!ud(n.startAt,e.startAt)&&ud(n.endAt,e.endAt)}function Fo(n){return U.isDocumentKey(n.path)&&n.collectionGroup===null&&n.filters.length===0}function Uo(n,e){return n.filters.filter(t=>t instanceof Z&&t.field.isEqual(e))}function ld(n,e,t){let r=Ao,i=!0;for(const s of Uo(n,e)){let o=Ao,c=!0;switch(s.op){case"<":case"<=":o=LE(s.value);break;case"==":case"in":case">=":o=s.value;break;case">":o=s.value,c=!1;break;case"!=":case"not-in":o=Ao}od({value:r,inclusive:i},{value:o,inclusive:c})<0&&(r=o,i=c)}if(t!==null){for(let s=0;s<n.orderBy.length;++s)if(n.orderBy[s].field.isEqual(e)){const o=t.position[s];od({value:r,inclusive:i},{value:o,inclusive:t.inclusive})<0&&(r=o,i=t.inclusive);break}}return{value:r,inclusive:i}}function hd(n,e,t){let r=an,i=!0;for(const s of Uo(n,e)){let o=an,c=!0;switch(s.op){case">=":case">":o=ME(s.value),c=!1;break;case"==":case"in":case"<=":o=s.value;break;case"<":o=s.value,c=!1;break;case"!=":case"not-in":o=an}ad({value:r,inclusive:i},{value:o,inclusive:c})>0&&(r=o,i=c)}if(t!==null){for(let s=0;s<n.orderBy.length;++s)if(n.orderBy[s].field.isEqual(e)){const o=t.position[s];ad({value:r,inclusive:i},{value:o,inclusive:t.inclusive})>0&&(r=o,i=t.inclusive);break}}return{value:r,inclusive:i}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const HE=new ae(U.comparator);function tt(){return HE}const Hp=new ae(U.comparator);function zi(...n){let e=Hp;for(const t of n)e=e.insert(t.key,t);return e}function Wp(n){let e=Hp;return n.forEach((t,r)=>e=e.insert(t,r.overlayedDocument)),e}function yt(){return Ji()}function Qp(){return Ji()}function Ji(){return new Gt(n=>n.toString(),(n,e)=>n.isEqual(e))}const WE=new ae(U.comparator),QE=new ie(U.comparator);function Q(...n){let e=QE;for(const t of n)e=e.add(t);return e}const JE=new ie(H);function yu(){return JE}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Iu(n,e){if(n.useProto3Json){if(isNaN(e))return{doubleValue:"NaN"};if(e===1/0)return{doubleValue:"Infinity"};if(e===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:os(e)?"-0":e}}function Jp(n){return{integerValue:""+n}}function Yp(n,e){return wp(e)?Jp(e):Iu(n,e)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ha{constructor(){this._=void 0}}function YE(n,e,t){return n instanceof Fr?function(i,s){const o={fields:{__type__:{stringValue:"server_timestamp"},__local_write_time__:{timestampValue:{seconds:i.seconds,nanos:i.nanoseconds}}}};return s&&ca(s)&&(s=ua(s)),s&&(o.fields.__previous_value__=s),{mapValue:o}}(t,e):n instanceof Zn?Zp(n,e):n instanceof er?em(n,e):function(i,s){const o=Xp(i,s),c=fd(o)+fd(i.Pe);return Fc(o)&&Fc(i.Pe)?Jp(c):Iu(i.serializer,c)}(n,e)}function XE(n,e,t){return n instanceof Zn?Zp(n,e):n instanceof er?em(n,e):t}function Xp(n,e){return n instanceof Ur?function(r){return Fc(r)||function(s){return!!s&&"doubleValue"in s}(r)}(e)?e:{integerValue:0}:null}class Fr extends ha{}class Zn extends ha{constructor(e){super(),this.elements=e}}function Zp(n,e){const t=tm(e);for(const r of n.elements)t.some(i=>wt(i,r))||t.push(r);return{arrayValue:{values:t}}}class er extends ha{constructor(e){super(),this.elements=e}}function em(n,e){let t=tm(e);for(const r of n.elements)t=t.filter(i=>!wt(i,r));return{arrayValue:{values:t}}}class Ur extends ha{constructor(e,t){super(),this.serializer=e,this.Pe=t}}function fd(n){return pe(n.integerValue||n.doubleValue)}function tm(n){return us(n)&&n.arrayValue.values?n.arrayValue.values.slice():[]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Rs{constructor(e,t){this.field=e,this.transform=t}}function ZE(n,e){return n.field.isEqual(e.field)&&function(r,i){return r instanceof Zn&&i instanceof Zn||r instanceof er&&i instanceof er?Vr(r.elements,i.elements,wt):r instanceof Ur&&i instanceof Ur?wt(r.Pe,i.Pe):r instanceof Fr&&i instanceof Fr}(n.transform,e.transform)}class ev{constructor(e,t){this.version=e,this.transformResults=t}}class me{constructor(e,t){this.updateTime=e,this.exists=t}static none(){return new me}static exists(e){return new me(void 0,e)}static updateTime(e){return new me(e)}get isNone(){return this.updateTime===void 0&&this.exists===void 0}isEqual(e){return this.exists===e.exists&&(this.updateTime?!!e.updateTime&&this.updateTime.isEqual(e.updateTime):!e.updateTime)}}function So(n,e){return n.updateTime!==void 0?e.isFoundDocument()&&e.version.isEqual(n.updateTime):n.exists===void 0||n.exists===e.isFoundDocument()}class da{}function nm(n,e){if(!n.hasLocalMutations||e&&e.fields.length===0)return null;if(e===null)return n.isNoDocument()?new Zr(n.key,me.none()):new Xr(n.key,n.data,me.none());{const t=n.data,r=Fe.empty();let i=new ie(he.comparator);for(let s of e.fields)if(!i.has(s)){let o=t.field(s);o===null&&s.length>1&&(s=s.popLast(),o=t.field(s)),o===null?r.delete(s):r.set(s,o),i=i.add(s)}return new $t(n.key,r,new et(i.toArray()),me.none())}}function tv(n,e,t){n instanceof Xr?function(i,s,o){const c=i.value.clone(),u=md(i.fieldTransforms,s,o.transformResults);c.setAll(u),s.convertToFoundDocument(o.version,c).setHasCommittedMutations()}(n,e,t):n instanceof $t?function(i,s,o){if(!So(i.precondition,s))return void s.convertToUnknownDocument(o.version);const c=md(i.fieldTransforms,s,o.transformResults),u=s.data;u.setAll(rm(i)),u.setAll(c),s.convertToFoundDocument(o.version,u).setHasCommittedMutations()}(n,e,t):function(i,s,o){s.convertToNoDocument(o.version).setHasCommittedMutations()}(0,e,t)}function Yi(n,e,t,r){return n instanceof Xr?function(s,o,c,u){if(!So(s.precondition,o))return c;const l=s.value.clone(),d=gd(s.fieldTransforms,u,o);return l.setAll(d),o.convertToFoundDocument(o.version,l).setHasLocalMutations(),null}(n,e,t,r):n instanceof $t?function(s,o,c,u){if(!So(s.precondition,o))return c;const l=gd(s.fieldTransforms,u,o),d=o.data;return d.setAll(rm(s)),d.setAll(l),o.convertToFoundDocument(o.version,d).setHasLocalMutations(),c===null?null:c.unionWith(s.fieldMask.fields).unionWith(s.fieldTransforms.map(p=>p.field))}(n,e,t,r):function(s,o,c){return So(s.precondition,o)?(o.convertToNoDocument(o.version).setHasLocalMutations(),null):c}(n,e,t)}function nv(n,e){let t=null;for(const r of n.fieldTransforms){const i=e.data.field(r.field),s=Xp(r.transform,i||null);s!=null&&(t===null&&(t=Fe.empty()),t.set(r.field,s))}return t||null}function pd(n,e){return n.type===e.type&&!!n.key.isEqual(e.key)&&!!n.precondition.isEqual(e.precondition)&&!!function(r,i){return r===void 0&&i===void 0||!(!r||!i)&&Vr(r,i,(s,o)=>ZE(s,o))}(n.fieldTransforms,e.fieldTransforms)&&(n.type===0?n.value.isEqual(e.value):n.type!==1||n.data.isEqual(e.data)&&n.fieldMask.isEqual(e.fieldMask))}class Xr extends da{constructor(e,t,r,i=[]){super(),this.key=e,this.value=t,this.precondition=r,this.fieldTransforms=i,this.type=0}getFieldMask(){return null}}class $t extends da{constructor(e,t,r,i,s=[]){super(),this.key=e,this.data=t,this.fieldMask=r,this.precondition=i,this.fieldTransforms=s,this.type=1}getFieldMask(){return this.fieldMask}}function rm(n){const e=new Map;return n.fieldMask.fields.forEach(t=>{if(!t.isEmpty()){const r=n.data.field(t);e.set(t,r)}}),e}function md(n,e,t){const r=new Map;z(n.length===t.length);for(let i=0;i<t.length;i++){const s=n[i],o=s.transform,c=e.data.field(s.field);r.set(s.field,XE(o,c,t[i]))}return r}function gd(n,e,t){const r=new Map;for(const i of n){const s=i.transform,o=t.data.field(i.field);r.set(i.field,YE(s,o,e))}return r}class Zr extends da{constructor(e,t){super(),this.key=e,this.precondition=t,this.type=2,this.fieldTransforms=[]}getFieldMask(){return null}}class Tu extends da{constructor(e,t){super(),this.key=e,this.precondition=t,this.type=3,this.fieldTransforms=[]}getFieldMask(){return null}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Eu{constructor(e,t,r,i){this.batchId=e,this.localWriteTime=t,this.baseMutations=r,this.mutations=i}applyToRemoteDocument(e,t){const r=t.mutationResults;for(let i=0;i<this.mutations.length;i++){const s=this.mutations[i];s.key.isEqual(e.key)&&tv(s,e,r[i])}}applyToLocalView(e,t){for(const r of this.baseMutations)r.key.isEqual(e.key)&&(t=Yi(r,e,t,this.localWriteTime));for(const r of this.mutations)r.key.isEqual(e.key)&&(t=Yi(r,e,t,this.localWriteTime));return t}applyToLocalDocumentSet(e,t){const r=Qp();return this.mutations.forEach(i=>{const s=e.get(i.key),o=s.overlayedDocument;let c=this.applyToLocalView(o,s.mutatedFields);c=t.has(i.key)?null:c;const u=nm(o,c);u!==null&&r.set(i.key,u),o.isValidDocument()||o.convertToNoDocument(K.min())}),r}keys(){return this.mutations.reduce((e,t)=>e.add(t.key),Q())}isEqual(e){return this.batchId===e.batchId&&Vr(this.mutations,e.mutations,(t,r)=>pd(t,r))&&Vr(this.baseMutations,e.baseMutations,(t,r)=>pd(t,r))}}class vu{constructor(e,t,r,i){this.batch=e,this.commitVersion=t,this.mutationResults=r,this.docVersions=i}static from(e,t,r){z(e.mutations.length===r.length);let i=function(){return WE}();const s=e.mutations;for(let o=0;o<s.length;o++)i=i.insert(s[o].key,r[o].version);return new vu(e,t,r,i)}}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const iv=new Hn([4294967295,4294967295],0);function _d(n){const e=am().encode(n),t=new cp;return t.update(e),new Uint8Array(t.digest())}function yd(n){const e=new DataView(n.buffer),t=e.getUint32(0,!0),r=e.getUint32(4,!0),i=e.getUint32(8,!0),s=e.getUint32(12,!0);return[new Hn([t,r],0),new Hn([i,s],0)]}class Au{constructor(e,t,r){if(this.bitmap=e,this.padding=t,this.hashCount=r,t<0||t>=8)throw new Gi(`Invalid padding: ${t}`);if(r<0)throw new Gi(`Invalid hash count: ${r}`);if(e.length>0&&this.hashCount===0)throw new Gi(`Invalid hash count: ${r}`);if(e.length===0&&t!==0)throw new Gi(`Invalid padding when bitmap length is 0: ${t}`);this.Ie=8*e.length-t,this.Te=Hn.fromNumber(this.Ie)}Ee(e,t,r){let i=e.add(t.multiply(Hn.fromNumber(r)));return i.compare(iv)===1&&(i=new Hn([i.getBits(0),i.getBits(1)],0)),i.modulo(this.Te).toNumber()}de(e){return(this.bitmap[Math.floor(e/8)]&1<<e%8)!=0}mightContain(e){if(this.Ie===0)return!1;const t=_d(e),[r,i]=yd(t);for(let s=0;s<this.hashCount;s++){const o=this.Ee(r,i,s);if(!this.de(o))return!1}return!0}static create(e,t,r){const i=e%8==0?0:8-e%8,s=new Uint8Array(Math.ceil(e/8)),o=new Au(s,i,t);return r.forEach(c=>o.insert(c)),o}insert(e){if(this.Ie===0)return;const t=_d(e),[r,i]=yd(t);for(let s=0;s<this.hashCount;s++){const o=this.Ee(r,i,s);this.Ae(o)}}Ae(e){const t=Math.floor(e/8),r=e%8;this.bitmap[t]|=1<<r}}class Gi extends Error{constructor(){super(...arguments),this.name="BloomFilterError"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bs{constructor(e,t,r,i,s){this.snapshotVersion=e,this.targetChanges=t,this.targetMismatches=r,this.documentUpdates=i,this.resolvedLimboDocuments=s}static createSynthesizedRemoteEventForCurrentChange(e,t,r){const i=new Map;return i.set(e,Ss.createSynthesizedTargetChangeForCurrentChange(e,t,r)),new bs(K.min(),i,new ae(H),tt(),Q())}}class Ss{constructor(e,t,r,i,s){this.resumeToken=e,this.current=t,this.addedDocuments=r,this.modifiedDocuments=i,this.removedDocuments=s}static createSynthesizedTargetChangeForCurrentChange(e,t,r){return new Ss(r,t,Q(),Q(),Q())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class vm{constructor(e){this.ct=e}}function Iv(n,e){let t;if(e.document)t=mm(n.ct,e.document,!!e.hasCommittedMutations);else if(e.noDocument){const r=U.fromSegments(e.noDocument.path),i=nr(e.noDocument.readTime);t=le.newNoDocument(r,i),e.hasCommittedMutations&&t.setHasCommittedMutations()}else{if(!e.unknownDocument)return j();{const r=U.fromSegments(e.unknownDocument.path),i=nr(e.unknownDocument.version);t=le.newUnknownDocument(r,i)}}return e.readTime&&t.setReadTime(function(i){const s=new ge(i[0],i[1]);return K.fromTimestamp(s)}(e.readTime)),t}function wd(n,e){const t=e.key,r={prefixPath:t.getCollectionPath().popLast().toArray(),collectionGroup:t.collectionGroup,documentId:t.path.lastSegment(),readTime:jo(e.readTime),hasCommittedMutations:e.hasCommittedMutations};if(e.isFoundDocument())r.document=function(s,o){return{name:hs(s,o.key),fields:o.data.value.mapValue.fields,updateTime:Br(s,o.version.toTimestamp()),createTime:Br(s,o.createTime.toTimestamp())}}(n.ct,e);else if(e.isNoDocument())r.noDocument={path:t.path.toArray(),readTime:tr(e.version)};else{if(!e.isUnknownDocument())return j();r.unknownDocument={path:t.path.toArray(),version:tr(e.version)}}return r}function jo(n){const e=n.toTimestamp();return[e.seconds,e.nanoseconds]}function tr(n){const e=n.toTimestamp();return{seconds:e.seconds,nanoseconds:e.nanoseconds}}function nr(n){const e=new ge(n.seconds,n.nanoseconds);return K.fromTimestamp(e)}function zn(n,e){const t=(e.baseMutations||[]).map(s=>Kc(n.ct,s));for(let s=0;s<e.mutations.length-1;++s){const o=e.mutations[s];if(s+1<e.mutations.length&&e.mutations[s+1].transform!==void 0){const c=e.mutations[s+1];o.updateTransforms=c.transform.fieldTransforms,e.mutations.splice(s+1,1),++s}}const r=e.mutations.map(s=>Kc(n.ct,s)),i=ge.fromMillis(e.localWriteTimeMs);return new Eu(e.batchId,i,t,r)}function $i(n){const e=nr(n.readTime),t=n.lastLimboFreeSnapshotVersion!==void 0?nr(n.lastLimboFreeSnapshotVersion):K.min();let r;return r=function(s){return s.documents!==void 0}(n.query)?function(s){return z(s.documents.length===1),He(Yr(fm(s.documents[0])))}(n.query):function(s){return He(ym(s))}(n.query),new Vt(r,n.targetId,"TargetPurposeListen",n.lastListenSequenceNumber,e,t,Ie.fromBase64String(n.resumeToken))}function wm(n,e){const t=tr(e.snapshotVersion),r=tr(e.lastLimboFreeSnapshotVersion);let i;i=Fo(e.target)?gm(n.ct,e.target):fa(n.ct,e.target)._t;const s=e.resumeToken.toBase64();return{targetId:e.targetId,canonicalId:Xn(e.target),readTime:t,resumeToken:s,lastListenSequenceNumber:e.sequenceNumber,lastLimboFreeSnapshotVersion:r,query:i}}function bu(n){const e=ym({parent:n.parent,structuredQuery:n.structuredQuery});return n.limitType==="LAST"?Bo(e,e.limit,"L"):e}function gc(n,e){return new wu(e.largestBatchId,Kc(n.ct,e.overlayMutation))}function Ad(n,e){const t=e.path.lastSegment();return[n,Ke(e.path.popLast()),t]}function Rd(n,e,t,r){return{indexId:n,uid:e,sequenceNumber:t,readTime:tr(r.readTime),documentKey:Ke(r.documentKey.path),largestBatchId:r.largestBatchId}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Tv{getBundleMetadata(e,t){return bd(e).get(t).next(r=>{if(r)return function(s){return{id:s.bundleId,createTime:nr(s.createTime),version:s.version}}(r)})}saveBundleMetadata(e,t){return bd(e).put(function(i){return{bundleId:i.id,createTime:tr(be(i.createTime)),version:i.version}}(t))}getNamedQuery(e,t){return Sd(e).get(t).next(r=>{if(r)return function(s){return{name:s.name,query:bu(s.bundledQuery),readTime:nr(s.readTime)}}(r)})}saveNamedQuery(e,t){return Sd(e).put(function(i){return{name:i.name,readTime:tr(be(i.readTime)),bundledQuery:i.bundledQuery}}(t))}}function bd(n){return De(n,"bundles")}function Sd(n){return De(n,"namedQueries")}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class pa{constructor(e,t){this.serializer=e,this.userId=t}static lt(e,t){const r=t.uid||"";return new pa(e,r)}getOverlay(e,t){return ki(e).get(Ad(this.userId,t)).next(r=>r?gc(this.serializer,r):null)}getOverlays(e,t){const r=yt();return A.forEach(t,i=>this.getOverlay(e,i).next(s=>{s!==null&&r.set(i,s)})).next(()=>r)}saveOverlays(e,t,r){const i=[];return r.forEach((s,o)=>{const c=new wu(t,o);i.push(this.ht(e,c))}),A.waitFor(i)}removeOverlaysForBatchId(e,t,r){const i=new Set;t.forEach(o=>i.add(Ke(o.getCollectionPath())));const s=[];return i.forEach(o=>{const c=IDBKeyRange.bound([this.userId,o,r],[this.userId,o,r+1],!1,!0);s.push(ki(e).j("collectionPathOverlayIndex",c))}),A.waitFor(s)}getOverlaysForCollection(e,t,r){const i=yt(),s=Ke(t),o=IDBKeyRange.bound([this.userId,s,r],[this.userId,s,Number.POSITIVE_INFINITY],!0);return ki(e).U("collectionPathOverlayIndex",o).next(c=>{for(const u of c){const l=gc(this.serializer,u);i.set(l.getKey(),l)}return i})}getOverlaysForCollectionGroup(e,t,r,i){const s=yt();let o;const c=IDBKeyRange.bound([this.userId,t,r],[this.userId,t,Number.POSITIVE_INFINITY],!0);return ki(e).J({index:"collectionGroupOverlayIndex",range:c},(u,l,d)=>{const p=gc(this.serializer,l);s.size()<i||p.largestBatchId===o?(s.set(p.getKey(),p),o=p.largestBatchId):d.done()}).next(()=>s)}ht(e,t){return ki(e).put(function(i,s,o){const[c,u,l]=Ad(s,o.mutation.key);return{userId:s,collectionPath:u,documentId:l,collectionGroup:o.mutation.key.getCollectionGroup(),largestBatchId:o.largestBatchId,overlayMutation:ds(i.ct,o.mutation)}}(this.serializer,this.userId,t))}}function ki(n){return De(n,"documentOverlays")}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $n{constructor(e,t,r,i){this.indexId=e,this.documentKey=t,this.arrayValue=r,this.directionalValue=i}Zt(){const e=this.directionalValue.length,t=e===0||this.directionalValue[e-1]===255?e+1:e,r=new Uint8Array(t);return r.set(this.directionalValue,0),t!==e?r.set([0],this.directionalValue.length):++r[r.length-1],new $n(this.indexId,this.documentKey,this.arrayValue,r)}}function en(n,e){let t=n.indexId-e.indexId;return t!==0?t:(t=Cd(n.arrayValue,e.arrayValue),t!==0?t:(t=Cd(n.directionalValue,e.directionalValue),t!==0?t:U.comparator(n.documentKey,e.documentKey)))}function Cd(n,e){for(let t=0;t<n.length&&t<e.length;++t){const r=n[t]-e[t];if(r!==0)return r}return n.length-e.length}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Am(n){var e,t;if(z(n instanceof Z||n instanceof re),n instanceof Z){if(n instanceof Bp){const i=((t=(e=n.value.arrayValue)===null||e===void 0?void 0:e.values)===null||t===void 0?void 0:t.map(s=>Z.create(n.field,"==",s)))||[];return re.create(i,"or")}return n}const r=n.filters.map(i=>Am(i));return re.create(r,n.op)}function bv(n){if(n.getFilters().length===0)return[];const e=Qc(Am(n));return z(Rm(e)),Hc(e)||Wc(e)?[e]:e.getFilters()}function Hc(n){return n instanceof Z}function Wc(n){return n instanceof re&&gu(n)}function Rm(n){return Hc(n)||Wc(n)||function(t){if(t instanceof re&&Uc(t)){for(const r of t.getFilters())if(!Hc(r)&&!Wc(r))return!1;return!0}return!1}(n)}function Qc(n){if(z(n instanceof Z||n instanceof re),n instanceof Z)return n;if(n.filters.length===1)return Qc(n.filters[0]);const e=n.filters.map(r=>Qc(r));let t=re.create(e,n.op);return t=zo(t),Rm(t)?t:(z(t instanceof re),z(Mr(t)),z(t.filters.length>1),t.filters.reduce((r,i)=>Su(r,i)))}function Su(n,e){let t;return z(n instanceof Z||n instanceof re),z(e instanceof Z||e instanceof re),t=n instanceof Z?e instanceof Z?function(i,s){return re.create([i,s],"and")}(n,e):kd(n,e):e instanceof Z?kd(e,n):function(i,s){if(z(i.filters.length>0&&s.filters.length>0),Mr(i)&&Mr(s))return Mp(i,s.getFilters());const o=Uc(i)?i:s,c=Uc(i)?s:i,u=o.filters.map(l=>Su(l,c));return re.create(u,"or")}(n,e),zo(t)}function kd(n,e){if(Mr(e))return Mp(e,n.getFilters());{const t=e.filters.map(r=>Su(n,r));return re.create(t,"or")}}function zo(n){if(z(n instanceof Z||n instanceof re),n instanceof Z)return n;const e=n.getFilters();if(e.length===1)return zo(e[0]);if(xp(n))return n;const t=e.map(i=>zo(i)),r=[];return t.forEach(i=>{i instanceof Z?r.push(i):i instanceof re&&(i.op===n.op?r.push(...i.filters):r.push(i))}),r.length===1?r[0]:re.create(r,n.op)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const uo=new Uint8Array(0);class Pv{constructor(e,t){this.databaseId=t,this.cn=new Pu,this.ln=new Gt(r=>Xn(r),(r,i)=>vs(r,i)),this.uid=e.uid||""}addToCollectionParentIndex(e,t){if(!this.cn.has(t)){const r=t.lastSegment(),i=t.popLast();e.addOnCommittedListener(()=>{this.cn.add(t)});const s={collectionId:r,parent:Ke(i)};return Nd(e).put(s)}return A.resolve()}getCollectionParents(e,t){const r=[],i=IDBKeyRange.bound([t,""],[_p(t),""],!1,!0);return Nd(e).U(i).next(s=>{for(const o of s){if(o.collectionId!==t)break;r.push(_t(o.parent))}return r})}addFieldIndex(e,t){const r=Vi(e),i=function(c){return{indexId:c.indexId,collectionGroup:c.collectionGroup,fields:c.fields.map(u=>[u.fieldPath.canonicalString(),u.kind])}}(t);delete i.indexId;const s=r.add(i);if(t.indexState){const o=Ir(e);return s.next(c=>{o.put(Rd(c,this.uid,t.indexState.sequenceNumber,t.indexState.offset))})}return s.next()}deleteFieldIndex(e,t){const r=Vi(e),i=Ir(e),s=yr(e);return r.delete(t.indexId).next(()=>i.delete(IDBKeyRange.bound([t.indexId],[t.indexId+1],!1,!0))).next(()=>s.delete(IDBKeyRange.bound([t.indexId],[t.indexId+1],!1,!0)))}deleteAllFieldIndexes(e){const t=Vi(e),r=yr(e),i=Ir(e);return t.j().next(()=>r.j()).next(()=>i.j())}createTargetIndexes(e,t){return A.forEach(this.hn(t),r=>this.getIndexType(e,r).next(i=>{if(i===0||i===1){const s=new Dd(r).an();if(s!=null)return this.addFieldIndex(e,s)}}))}getDocumentsMatchingTarget(e,t){const r=yr(e);let i=!0;const s=new Map;return A.forEach(this.hn(t),o=>this.Pn(e,o).next(c=>{i&&(i=!!c),s.set(o,c)})).next(()=>{if(i){let o=Q();const c=[];return A.forEach(s,(u,l)=>{V("IndexedDbIndexManager",`Using index ${function(O){return`id=${O.indexId}|cg=${O.collectionGroup}|f=${O.fields.map(G=>`${G.fieldPath}:${G.kind}`).join(",")}`}(u)} to execute ${Xn(t)}`);const d=function(O,G){const W=xc(G);if(W===void 0)return null;for(const $ of Uo(O,W.fieldPath))switch($.op){case"array-contains-any":return $.value.arrayValue.values||[];case"array-contains":return[$.value]}return null}(l,u),p=function(O,G){const W=new Map;for(const $ of Bn(G))for(const E of Uo(O,$.fieldPath))switch(E.op){case"==":case"in":W.set($.fieldPath.canonicalString(),E.value);break;case"not-in":case"!=":return W.set($.fieldPath.canonicalString(),E.value),Array.from(W.values())}return null}(l,u),g=function(O,G){const W=[];let $=!0;for(const E of Bn(G)){const _=E.kind===0?ld(O,E.fieldPath,O.startAt):hd(O,E.fieldPath,O.startAt);W.push(_.value),$&&($=_.inclusive)}return new Tn(W,$)}(l,u),T=function(O,G){const W=[];let $=!0;for(const E of Bn(G)){const _=E.kind===0?hd(O,E.fieldPath,O.endAt):ld(O,E.fieldPath,O.endAt);W.push(_.value),$&&($=_.inclusive)}return new Tn(W,$)}(l,u),S=this.In(u,l,g),k=this.In(u,l,T),C=this.Tn(u,l,p),B=this.En(u.indexId,d,S,g.inclusive,k,T.inclusive,C);return A.forEach(B,M=>r.G(M,t.limit).next(O=>{O.forEach(G=>{const W=U.fromSegments(G.documentKey);o.has(W)||(o=o.add(W),c.push(W))})}))}).next(()=>c)}return A.resolve(null)})}hn(e){let t=this.ln.get(e);return t||(e.filters.length===0?t=[e]:t=bv(re.create(e.filters,"and")).map(r=>qc(e.path,e.collectionGroup,e.orderBy,r.getFilters(),e.limit,e.startAt,e.endAt)),this.ln.set(e,t),t)}En(e,t,r,i,s,o,c){const u=(t!=null?t.length:1)*Math.max(r.length,s.length),l=u/(t!=null?t.length:1),d=[];for(let p=0;p<u;++p){const g=t?this.dn(t[p/l]):uo,T=this.An(e,g,r[p%l],i),S=this.Rn(e,g,s[p%l],o),k=c.map(C=>this.An(e,g,C,!0));d.push(...this.createRange(T,S,k))}return d}An(e,t,r,i){const s=new $n(e,U.empty(),t,r);return i?s:s.Zt()}Rn(e,t,r,i){const s=new $n(e,U.empty(),t,r);return i?s.Zt():s}Pn(e,t){const r=new Dd(t),i=t.collectionGroup!=null?t.collectionGroup:t.path.lastSegment();return this.getFieldIndexes(e,i).next(s=>{let o=null;for(const c of s)r.rn(c)&&(!o||c.fields.length>o.fields.length)&&(o=c);return o})}getIndexType(e,t){let r=2;const i=this.hn(t);return A.forEach(i,s=>this.Pn(e,s).next(o=>{o?r!==0&&o.fields.length<function(u){let l=new ie(he.comparator),d=!1;for(const p of u.filters)for(const g of p.getFlattenedFilters())g.field.isKeyField()||(g.op==="array-contains"||g.op==="array-contains-any"?d=!0:l=l.add(g.field));for(const p of u.orderBy)p.field.isKeyField()||(l=l.add(p.field));return l.size+(d?1:0)}(s)&&(r=1):r=0})).next(()=>function(o){return o.limit!==null}(t)&&i.length>1&&r===2?1:r)}Vn(e,t){const r=new Ni;for(const i of Bn(e)){const s=t.data.field(i.fieldPath);if(s==null)return null;const o=r.Yt(i.kind);Gn.vt.It(s,o)}return r.zt()}dn(e){const t=new Ni;return Gn.vt.It(e,t.Yt(0)),t.zt()}mn(e,t){const r=new Ni;return Gn.vt.It(Yn(this.databaseId,t),r.Yt(function(s){const o=Bn(s);return o.length===0?0:o[o.length-1].kind}(e))),r.zt()}Tn(e,t,r){if(r===null)return[];let i=[];i.push(new Ni);let s=0;for(const o of Bn(e)){const c=r[s++];for(const u of i)if(this.fn(t,o.fieldPath)&&us(c))i=this.gn(i,o,c);else{const l=u.Yt(o.kind);Gn.vt.It(c,l)}}return this.pn(i)}In(e,t,r){return this.Tn(e,t,r.position)}pn(e){const t=[];for(let r=0;r<e.length;++r)t[r]=e[r].zt();return t}gn(e,t,r){const i=[...e],s=[];for(const o of r.arrayValue.values||[])for(const c of i){const u=new Ni;u.seed(c.zt()),Gn.vt.It(o,u.Yt(t.kind)),s.push(u)}return s}fn(e,t){return!!e.filters.find(r=>r instanceof Z&&r.field.isEqual(t)&&(r.op==="in"||r.op==="not-in"))}getFieldIndexes(e,t){const r=Vi(e),i=Ir(e);return(t?r.U("collectionGroupIndex",IDBKeyRange.bound(t,t)):r.U()).next(s=>{const o=[];return A.forEach(s,c=>i.get([c.indexId,this.uid]).next(u=>{o.push(function(d,p){const g=p?new xr(p.sequenceNumber,new st(nr(p.readTime),new U(_t(p.documentKey)),p.largestBatchId)):xr.empty(),T=d.fields.map(([S,k])=>new Wn(he.fromServerFormat(S),k));return new Or(d.indexId,d.collectionGroup,T,g)}(c,u))})).next(()=>o)})}getNextCollectionGroupToUpdate(e){return this.getFieldIndexes(e).next(t=>t.length===0?null:(t.sort((r,i)=>{const s=r.indexState.sequenceNumber-i.indexState.sequenceNumber;return s!==0?s:H(r.collectionGroup,i.collectionGroup)}),t[0].collectionGroup))}updateCollectionGroup(e,t,r){const i=Vi(e),s=Ir(e);return this.yn(e).next(o=>i.U("collectionGroupIndex",IDBKeyRange.bound(t,t)).next(c=>A.forEach(c,u=>s.put(Rd(u.indexId,this.uid,o,r)))))}updateIndexEntries(e,t){const r=new Map;return A.forEach(t,(i,s)=>{const o=r.get(i.collectionGroup);return(o?A.resolve(o):this.getFieldIndexes(e,i.collectionGroup)).next(c=>(r.set(i.collectionGroup,c),A.forEach(c,u=>this.wn(e,i,u).next(l=>{const d=this.Sn(s,u);return l.isEqual(d)?A.resolve():this.bn(e,s,u,l,d)}))))})}Dn(e,t,r,i){return yr(e).put({indexId:i.indexId,uid:this.uid,arrayValue:i.arrayValue,directionalValue:i.directionalValue,orderedDocumentKey:this.mn(r,t.key),documentKey:t.key.path.toArray()})}vn(e,t,r,i){return yr(e).delete([i.indexId,this.uid,i.arrayValue,i.directionalValue,this.mn(r,t.key),t.key.path.toArray()])}wn(e,t,r){const i=yr(e);let s=new ie(en);return i.J({index:"documentKeyIndex",range:IDBKeyRange.only([r.indexId,this.uid,this.mn(r,t)])},(o,c)=>{s=s.add(new $n(r.indexId,t,c.arrayValue,c.directionalValue))}).next(()=>s)}Sn(e,t){let r=new ie(en);const i=this.Vn(t,e);if(i==null)return r;const s=xc(t);if(s!=null){const o=e.data.field(s.fieldPath);if(us(o))for(const c of o.arrayValue.values||[])r=r.add(new $n(t.indexId,e.key,this.dn(c),i))}else r=r.add(new $n(t.indexId,e.key,uo,i));return r}bn(e,t,r,i,s){V("IndexedDbIndexManager","Updating index entries for document '%s'",t.key);const o=[];return function(u,l,d,p,g){const T=u.getIterator(),S=l.getIterator();let k=_r(T),C=_r(S);for(;k||C;){let B=!1,M=!1;if(k&&C){const O=d(k,C);O<0?M=!0:O>0&&(B=!0)}else k!=null?M=!0:B=!0;B?(p(C),C=_r(S)):M?(g(k),k=_r(T)):(k=_r(T),C=_r(S))}}(i,s,en,c=>{o.push(this.Dn(e,t,r,c))},c=>{o.push(this.vn(e,t,r,c))}),A.waitFor(o)}yn(e){let t=1;return Ir(e).J({index:"sequenceNumberIndex",reverse:!0,range:IDBKeyRange.upperBound([this.uid,Number.MAX_SAFE_INTEGER])},(r,i,s)=>{s.done(),t=i.sequenceNumber+1}).next(()=>t)}createRange(e,t,r){r=r.sort((o,c)=>en(o,c)).filter((o,c,u)=>!c||en(o,u[c-1])!==0);const i=[];i.push(e);for(const o of r){const c=en(o,e),u=en(o,t);if(c===0)i[0]=e.Zt();else if(c>0&&u<0)i.push(o),i.push(o.Zt());else if(u>0)break}i.push(t);const s=[];for(let o=0;o<i.length;o+=2){if(this.Cn(i[o],i[o+1]))return[];const c=[i[o].indexId,this.uid,i[o].arrayValue,i[o].directionalValue,uo,[]],u=[i[o+1].indexId,this.uid,i[o+1].arrayValue,i[o+1].directionalValue,uo,[]];s.push(IDBKeyRange.bound(c,u))}return s}Cn(e,t){return en(e,t)>0}getMinOffsetFromCollectionGroup(e,t){return this.getFieldIndexes(e,t).next(Vd)}getMinOffset(e,t){return A.mapArray(this.hn(t),r=>this.Pn(e,r).next(i=>i||j())).next(Vd)}}function Nd(n){return De(n,"collectionParents")}function yr(n){return De(n,"indexEntries")}function Vi(n){return De(n,"indexConfiguration")}function Ir(n){return De(n,"indexState")}function Vd(n){z(n.length!==0);let e=n[0].indexState.offset,t=e.largestBatchId;for(let r=1;r<n.length;r++){const i=n[r].indexState.offset;fu(i,e)<0&&(e=i),t<i.largestBatchId&&(t=i.largestBatchId)}return new st(e.readTime,e.documentKey,t)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Od={didRun:!1,sequenceNumbersCollected:0,targetsRemoved:0,documentsRemoved:0};class Ge{constructor(e,t,r){this.cacheSizeCollectionThreshold=e,this.percentileToCollect=t,this.maximumSequenceNumbersToCollect=r}static withCacheSize(e){return new Ge(e,Ge.DEFAULT_COLLECTION_PERCENTILE,Ge.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Vv{constructor(e){this.serializer=e}setIndexManager(e){this.indexManager=e}addEntry(e,t,r){return Fn(e).put(r)}removeEntry(e,t,r){return Fn(e).delete(function(s,o){const c=s.path.toArray();return[c.slice(0,c.length-2),c[c.length-2],jo(o),c[c.length-1]]}(t,r))}updateMetadata(e,t){return this.getMetadata(e).next(r=>(r.byteSize+=t,this.rr(e,r)))}getEntry(e,t){let r=le.newInvalidDocument(t);return Fn(e).J({index:"documentKeyIndex",range:IDBKeyRange.only(Oi(t))},(i,s)=>{r=this.ir(t,s)}).next(()=>r)}sr(e,t){let r={size:0,document:le.newInvalidDocument(t)};return Fn(e).J({index:"documentKeyIndex",range:IDBKeyRange.only(Oi(t))},(i,s)=>{r={document:this.ir(t,s),size:Go(s)}}).next(()=>r)}getEntries(e,t){let r=tt();return this._r(e,t,(i,s)=>{const o=this.ir(i,s);r=r.insert(i,o)}).next(()=>r)}ar(e,t){let r=tt(),i=new ae(U.comparator);return this._r(e,t,(s,o)=>{const c=this.ir(s,o);r=r.insert(s,c),i=i.insert(s,Go(o))}).next(()=>({documents:r,ur:i}))}_r(e,t,r){if(t.isEmpty())return A.resolve();let i=new ie(Ud);t.forEach(u=>i=i.add(u));const s=IDBKeyRange.bound(Oi(i.first()),Oi(i.last())),o=i.getIterator();let c=o.getNext();return Fn(e).J({index:"documentKeyIndex",range:s},(u,l,d)=>{const p=U.fromSegments([...l.prefixPath,l.collectionGroup,l.documentId]);for(;c&&Ud(c,p)<0;)r(c,null),c=o.getNext();c&&c.isEqual(p)&&(r(c,l),c=o.hasNext()?o.getNext():null),c?d.$(Oi(c)):d.done()}).next(()=>{for(;c;)r(c,null),c=o.hasNext()?o.getNext():null})}getDocumentsMatchingQuery(e,t,r,i,s){const o=t.path,c=[o.popLast().toArray(),o.lastSegment(),jo(r.readTime),r.documentKey.path.isEmpty()?"":r.documentKey.path.lastSegment()],u=[o.popLast().toArray(),o.lastSegment(),[Number.MAX_SAFE_INTEGER,Number.MAX_SAFE_INTEGER],""];return Fn(e).U(IDBKeyRange.bound(c,u,!0)).next(l=>{s==null||s.incrementDocumentReadCount(l.length);let d=tt();for(const p of l){const g=this.ir(U.fromSegments(p.prefixPath.concat(p.collectionGroup,p.documentId)),p);g.isFoundDocument()&&(As(t,g)||i.has(g.key))&&(d=d.insert(g.key,g))}return d})}getAllFromCollectionGroup(e,t,r,i){let s=tt();const o=Fd(t,r),c=Fd(t,st.max());return Fn(e).J({index:"collectionGroupIndex",range:IDBKeyRange.bound(o,c,!0)},(u,l,d)=>{const p=this.ir(U.fromSegments(l.prefixPath.concat(l.collectionGroup,l.documentId)),l);s=s.insert(p.key,p),s.size===i&&d.done()}).next(()=>s)}newChangeBuffer(e){return new Ov(this,!!e&&e.trackRemovals)}getSize(e){return this.getMetadata(e).next(t=>t.byteSize)}getMetadata(e){return Md(e).get("remoteDocumentGlobalKey").next(t=>(z(!!t),t))}rr(e,t){return Md(e).put("remoteDocumentGlobalKey",t)}ir(e,t){if(t){const r=Iv(this.serializer,t);if(!(r.isNoDocument()&&r.version.isEqual(K.min())))return r}return le.newInvalidDocument(e)}}function Nm(n){return new Vv(n)}class Ov extends km{constructor(e,t){super(),this.cr=e,this.trackRemovals=t,this.lr=new Gt(r=>r.toString(),(r,i)=>r.isEqual(i))}applyChanges(e){const t=[];let r=0,i=new ie((s,o)=>H(s.canonicalString(),o.canonicalString()));return this.changes.forEach((s,o)=>{const c=this.lr.get(s);if(t.push(this.cr.removeEntry(e,s,c.readTime)),o.isValidDocument()){const u=wd(this.cr.serializer,o);i=i.add(s.path.popLast());const l=Go(u);r+=l-c.size,t.push(this.cr.addEntry(e,s,u))}else if(r-=c.size,this.trackRemovals){const u=wd(this.cr.serializer,o.convertToNoDocument(K.min()));t.push(this.cr.addEntry(e,s,u))}}),i.forEach(s=>{t.push(this.cr.indexManager.addToCollectionParentIndex(e,s))}),t.push(this.cr.updateMetadata(e,r)),A.waitFor(t)}getFromCache(e,t){return this.cr.sr(e,t).next(r=>(this.lr.set(t,{size:r.size,readTime:r.document.readTime}),r.document))}getAllFromCache(e,t){return this.cr.ar(e,t).next(({documents:r,ur:i})=>(i.forEach((s,o)=>{this.lr.set(s,{size:o,readTime:r.get(s).readTime})}),r))}}function Md(n){return De(n,"remoteDocumentGlobal")}function Fn(n){return De(n,"remoteDocumentsV14")}function Oi(n){const e=n.path.toArray();return[e.slice(0,e.length-2),e[e.length-2],e[e.length-1]]}function Fd(n,e){const t=e.documentKey.path.toArray();return[n,jo(e.readTime),t.slice(0,t.length-2),t.length>0?t[t.length-1]:""]}function Ud(n,e){const t=n.path.toArray(),r=e.path.toArray();let i=0;for(let s=0;s<t.length-2&&s<r.length-2;++s)if(i=H(t[s],r[s]),i)return i;return i=H(t.length,r.length),i||(i=H(t[t.length-2],r[r.length-2]),i||H(t[t.length-1],r[r.length-1]))}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Vu{constructor(e,t,r,i){this.targetId=e,this.fromCache=t,this.$i=r,this.Ui=i}static Wi(e,t){let r=Q(),i=Q();for(const s of t.docChanges)switch(s.type){case 0:r=r.add(s.doc.key);break;case 1:i=i.add(s.doc.key)}return new Vu(e,t.fromCache,r,i)}}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let fo=null;function Tc(){return fo===null?fo=function(){return 268435456+Math.round(2147483648*Math.random())}():fo++,"0x"+fo.toString(16)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Gm{constructor(e,t,r,i,s,o,c,u){this.ui=e,this.Ho=r,this.Jo=i,this.connection=s,this.authCredentialsProvider=o,this.appCheckCredentialsProvider=c,this.listener=u,this.state=0,this.Yo=0,this.Zo=null,this.Xo=null,this.stream=null,this.e_=0,this.t_=new xu(e,t)}n_(){return this.state===1||this.state===5||this.r_()}r_(){return this.state===2||this.state===3}start(){this.e_=0,this.state!==4?this.auth():this.i_()}async stop(){this.n_()&&await this.close(0)}s_(){this.state=0,this.t_.reset()}o_(){this.r_()&&this.Zo===null&&(this.Zo=this.ui.enqueueAfterDelay(this.Ho,6e4,()=>this.__()))}a_(e){this.u_(),this.stream.send(e)}async __(){if(this.r_())return this.close(0)}u_(){this.Zo&&(this.Zo.cancel(),this.Zo=null)}c_(){this.Xo&&(this.Xo.cancel(),this.Xo=null)}async close(e,t){this.u_(),this.c_(),this.t_.cancel(),this.Yo++,e!==4?this.t_.reset():t&&t.code===P.RESOURCE_EXHAUSTED?(Re(t.toString()),Re("Using maximum backoff delay to prevent overloading the backend."),this.t_.Wo()):t&&t.code===P.UNAUTHENTICATED&&this.state!==3&&(this.authCredentialsProvider.invalidateToken(),this.appCheckCredentialsProvider.invalidateToken()),this.stream!==null&&(this.l_(),this.stream.close(),this.stream=null),this.state=e,await this.listener.mo(t)}l_(){}auth(){this.state=1;const e=this.h_(this.Yo),t=this.Yo;Promise.all([this.authCredentialsProvider.getToken(),this.appCheckCredentialsProvider.getToken()]).then(([r,i])=>{this.Yo===t&&this.P_(r,i)},r=>{e(()=>{const i=new N(P.UNKNOWN,"Fetching auth token failed: "+r.message);return this.I_(i)})})}P_(e,t){const r=this.h_(this.Yo);this.stream=this.T_(e,t),this.stream.Eo(()=>{r(()=>this.listener.Eo())}),this.stream.Ro(()=>{r(()=>(this.state=2,this.Xo=this.ui.enqueueAfterDelay(this.Jo,1e4,()=>(this.r_()&&(this.state=3),Promise.resolve())),this.listener.Ro()))}),this.stream.mo(i=>{r(()=>this.I_(i))}),this.stream.onMessage(i=>{r(()=>++this.e_==1?this.E_(i):this.onNext(i))})}i_(){this.state=5,this.t_.Go(async()=>{this.state=0,this.start()})}I_(e){return V("PersistentStream",`close with error: ${e}`),this.stream=null,this.close(4,e)}h_(e){return t=>{this.ui.enqueueAndForget(()=>this.Yo===e?t():(V("PersistentStream","stream callback skipped by getCloseGuardedDispatcher."),Promise.resolve()))}}}class nw extends Gm{constructor(e,t,r,i,s,o){super(e,"listen_stream_connection_backoff","listen_stream_idle","health_check_timeout",t,r,i,o),this.serializer=s}T_(e,t){return this.connection.Bo("Listen",e,t)}E_(e){return this.onNext(e)}onNext(e){this.t_.reset();const t=dv(this.serializer,e),r=function(s){if(!("targetChange"in s))return K.min();const o=s.targetChange;return o.targetIds&&o.targetIds.length?K.min():o.readTime?be(o.readTime):K.min()}(e);return this.listener.d_(t,r)}A_(e){const t={};t.database=$c(this.serializer),t.addTarget=function(s,o){let c;const u=o.target;if(c=Fo(u)?{documents:gm(s,u)}:{query:fa(s,u)._t},c.targetId=o.targetId,o.resumeToken.approximateByteSize()>0){c.resumeToken=lm(s,o.resumeToken);const l=zc(s,o.expectedCount);l!==null&&(c.expectedCount=l)}else if(o.snapshotVersion.compareTo(K.min())>0){c.readTime=Br(s,o.snapshotVersion.toTimestamp());const l=zc(s,o.expectedCount);l!==null&&(c.expectedCount=l)}return c}(this.serializer,e);const r=pv(this.serializer,e);r&&(t.labels=r),this.a_(t)}R_(e){const t={};t.database=$c(this.serializer),t.removeTarget=e,this.a_(t)}}class rw extends Gm{constructor(e,t,r,i,s,o){super(e,"write_stream_connection_backoff","write_stream_idle","health_check_timeout",t,r,i,o),this.serializer=s}get V_(){return this.e_>0}start(){this.lastStreamToken=void 0,super.start()}l_(){this.V_&&this.m_([])}T_(e,t){return this.connection.Bo("Write",e,t)}E_(e){return z(!!e.streamToken),this.lastStreamToken=e.streamToken,z(!e.writeResults||e.writeResults.length===0),this.listener.f_()}onNext(e){z(!!e.streamToken),this.lastStreamToken=e.streamToken,this.t_.reset();const t=fv(e.writeResults,e.commitTime),r=be(e.commitTime);return this.listener.g_(r,t)}p_(){const e={};e.database=$c(this.serializer),this.a_(e)}m_(e){const t={streamToken:this.lastStreamToken,writes:e.map(r=>ds(this.serializer,r))};this.a_(t)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ow{constructor(e,t,r,i,s){this.localStore=e,this.datastore=t,this.asyncQueue=r,this.remoteSyncer={},this.O_=[],this.N_=new Map,this.L_=new Set,this.B_=[],this.k_=s,this.k_._o(o=>{r.enqueueAndForget(async()=>{Cn(this)&&(V("RemoteStore","Restarting streams for network reachability change."),await async function(u){const l=L(u);l.L_.add(4),await ei(l),l.q_.set("Unknown"),l.L_.delete(4),await Cs(l)}(this))})}),this.q_=new sw(r,i)}}async function Cs(n){if(Cn(n))for(const e of n.B_)await e(!0)}async function ei(n){for(const e of n.B_)await e(!1)}function _a(n,e){const t=L(n);t.N_.has(e.targetId)||(t.N_.set(e.targetId,e),Fu(t)?Mu(t):ni(t).r_()&&Lu(t,e))}function zr(n,e){const t=L(n),r=ni(t);t.N_.delete(e),r.r_()&&$m(t,e),t.N_.size===0&&(r.r_()?r.o_():Cn(t)&&t.q_.set("Unknown"))}function Lu(n,e){if(n.Q_.xe(e.targetId),e.resumeToken.approximateByteSize()>0||e.snapshotVersion.compareTo(K.min())>0){const t=n.remoteSyncer.getRemoteKeysForTarget(e.targetId).size;e=e.withExpectedCount(t)}ni(n).A_(e)}function $m(n,e){n.Q_.xe(e),ni(n).R_(e)}function Mu(n){n.Q_=new sv({getRemoteKeysForTarget:e=>n.remoteSyncer.getRemoteKeysForTarget(e),ot:e=>n.N_.get(e)||null,tt:()=>n.datastore.serializer.databaseId}),ni(n).start(),n.q_.v_()}function Fu(n){return Cn(n)&&!ni(n).n_()&&n.N_.size>0}function Cn(n){return L(n).L_.size===0}function Km(n){n.Q_=void 0}async function aw(n){n.q_.set("Online")}async function cw(n){n.N_.forEach((e,t)=>{Lu(n,e)})}async function uw(n,e){Km(n),Fu(n)?(n.q_.M_(e),Mu(n)):n.q_.set("Unknown")}async function lw(n,e,t){if(n.q_.set("Online"),e instanceof um&&e.state===2&&e.cause)try{await async function(i,s){const o=s.cause;for(const c of s.targetIds)i.N_.has(c)&&(await i.remoteSyncer.rejectListen(c,o),i.N_.delete(c),i.Q_.removeTarget(c))}(n,e)}catch(r){V("RemoteStore","Failed to remove targets %s: %s ",e.targetIds.join(","),r),await Qo(n,r)}else if(e instanceof Po?n.Q_.Ke(e):e instanceof cm?n.Q_.He(e):n.Q_.We(e),!t.isEqual(K.min()))try{const r=await Mm(n.localStore);t.compareTo(r)>=0&&await function(s,o){const c=s.Q_.rt(o);return c.targetChanges.forEach((u,l)=>{if(u.resumeToken.approximateByteSize()>0){const d=s.N_.get(l);d&&s.N_.set(l,d.withResumeToken(u.resumeToken,o))}}),c.targetMismatches.forEach((u,l)=>{const d=s.N_.get(u);if(!d)return;s.N_.set(u,d.withResumeToken(Ie.EMPTY_BYTE_STRING,d.snapshotVersion)),$m(s,u);const p=new Vt(d.target,u,l,d.sequenceNumber);Lu(s,p)}),s.remoteSyncer.applyRemoteEvent(c)}(n,t)}catch(r){V("RemoteStore","Failed to raise snapshot:",r),await Qo(n,r)}}async function Qo(n,e,t){if(!Sn(e))throw e;n.L_.add(1),await ei(n),n.q_.set("Offline"),t||(t=()=>Mm(n.localStore)),n.asyncQueue.enqueueRetryable(async()=>{V("RemoteStore","Retrying IndexedDB access"),await t(),n.L_.delete(1),await Cs(n)})}function Hm(n,e){return e().catch(t=>Qo(n,t,e))}async function ti(n){const e=L(n),t=En(e);let r=e.O_.length>0?e.O_[e.O_.length-1].batchId:-1;for(;hw(e);)try{const i=await Qv(e.localStore,r);if(i===null){e.O_.length===0&&t.o_();break}r=i.batchId,dw(e,i)}catch(i){await Qo(e,i)}Wm(e)&&Qm(e)}function hw(n){return Cn(n)&&n.O_.length<10}function dw(n,e){n.O_.push(e);const t=En(n);t.r_()&&t.V_&&t.m_(e.mutations)}function Wm(n){return Cn(n)&&!En(n).n_()&&n.O_.length>0}function Qm(n){En(n).start()}async function fw(n){En(n).p_()}async function pw(n){const e=En(n);for(const t of n.O_)e.m_(t.mutations)}async function mw(n,e,t){const r=n.O_.shift(),i=vu.from(r,e,t);await Hm(n,()=>n.remoteSyncer.applySuccessfulWrite(i)),await ti(n)}async function gw(n,e){e&&En(n).V_&&await async function(r,i){if(function(o){return sm(o)&&o!==P.ABORTED}(i.code)){const s=r.O_.shift();En(r).s_(),await Hm(r,()=>r.remoteSyncer.rejectFailedWrite(s.batchId,i)),await ti(r)}}(n,e),Wm(n)&&Qm(n)}async function Gd(n,e){const t=L(n);t.asyncQueue.verifyOperationInProgress(),V("RemoteStore","RemoteStore received new credentials");const r=Cn(t);t.L_.add(3),await ei(t),r&&t.q_.set("Unknown"),await t.remoteSyncer.handleCredentialChange(e),t.L_.delete(3),await Cs(t)}async function Yc(n,e){const t=L(n);e?(t.L_.delete(2),await Cs(t)):e||(t.L_.add(2),await ei(t),t.q_.set("Unknown"))}function ni(n){return n.K_||(n.K_=function(t,r,i){const s=L(t);return s.w_(),new nw(r,s.connection,s.authCredentials,s.appCheckCredentials,s.serializer,i)}(n.datastore,n.asyncQueue,{Eo:aw.bind(null,n),Ro:cw.bind(null,n),mo:uw.bind(null,n),d_:lw.bind(null,n)}),n.B_.push(async e=>{e?(n.K_.s_(),Fu(n)?Mu(n):n.q_.set("Unknown")):(await n.K_.stop(),Km(n))})),n.K_}function En(n){return n.U_||(n.U_=function(t,r,i){const s=L(t);return s.w_(),new rw(r,s.connection,s.authCredentials,s.appCheckCredentials,s.serializer,i)}(n.datastore,n.asyncQueue,{Eo:()=>Promise.resolve(),Ro:fw.bind(null,n),mo:gw.bind(null,n),f_:pw.bind(null,n),g_:mw.bind(null,n)}),n.B_.push(async e=>{e?(n.U_.s_(),await ti(n)):(await n.U_.stop(),n.O_.length>0&&(V("RemoteStore",`Stopping write stream with ${n.O_.length} pending writes`),n.O_=[]))})),n.U_}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ym{constructor(e){this.key=e}}class Xm{constructor(e){this.key=e}}class Zm{constructor(e,t){this.query=e,this.Ta=t,this.Ea=null,this.hasCachedResults=!1,this.current=!1,this.da=Q(),this.mutatedKeys=Q(),this.Aa=Kp(e),this.Ra=new Sr(this.Aa)}get Va(){return this.Ta}ma(e,t){const r=t?t.fa:new $d,i=t?t.Ra:this.Ra;let s=t?t.mutatedKeys:this.mutatedKeys,o=i,c=!1;const u=this.query.limitType==="F"&&i.size===this.query.limit?i.last():null,l=this.query.limitType==="L"&&i.size===this.query.limit?i.first():null;if(e.inorderTraversal((d,p)=>{const g=i.get(d),T=As(this.query,p)?p:null,S=!!g&&this.mutatedKeys.has(g.key),k=!!T&&(T.hasLocalMutations||this.mutatedKeys.has(T.key)&&T.hasCommittedMutations);let C=!1;g&&T?g.data.isEqual(T.data)?S!==k&&(r.track({type:3,doc:T}),C=!0):this.ga(g,T)||(r.track({type:2,doc:T}),C=!0,(u&&this.Aa(T,u)>0||l&&this.Aa(T,l)<0)&&(c=!0)):!g&&T?(r.track({type:0,doc:T}),C=!0):g&&!T&&(r.track({type:1,doc:g}),C=!0,(u||l)&&(c=!0)),C&&(T?(o=o.add(T),s=k?s.add(d):s.delete(d)):(o=o.delete(d),s=s.delete(d)))}),this.query.limit!==null)for(;o.size>this.query.limit;){const d=this.query.limitType==="F"?o.last():o.first();o=o.delete(d.key),s=s.delete(d.key),r.track({type:1,doc:d})}return{Ra:o,fa:r,ns:c,mutatedKeys:s}}ga(e,t){return e.hasLocalMutations&&t.hasCommittedMutations&&!t.hasLocalMutations}applyChanges(e,t,r,i){const s=this.Ra;this.Ra=e.Ra,this.mutatedKeys=e.mutatedKeys;const o=e.fa.G_();o.sort((d,p)=>function(T,S){const k=C=>{switch(C){case 0:return 1;case 2:case 3:return 2;case 1:return 0;default:return j()}};return k(T)-k(S)}(d.type,p.type)||this.Aa(d.doc,p.doc)),this.pa(r),i=i!=null&&i;const c=t&&!i?this.ya():[],u=this.da.size===0&&this.current&&!i?1:0,l=u!==this.Ea;return this.Ea=u,o.length!==0||l?{snapshot:new Gr(this.query,e.Ra,s,o,e.mutatedKeys,u===0,l,!1,!!r&&r.resumeToken.approximateByteSize()>0),wa:c}:{wa:c}}Z_(e){return this.current&&e==="Offline"?(this.current=!1,this.applyChanges({Ra:this.Ra,fa:new $d,mutatedKeys:this.mutatedKeys,ns:!1},!1)):{wa:[]}}Sa(e){return!this.Ta.has(e)&&!!this.Ra.has(e)&&!this.Ra.get(e).hasLocalMutations}pa(e){e&&(e.addedDocuments.forEach(t=>this.Ta=this.Ta.add(t)),e.modifiedDocuments.forEach(t=>{}),e.removedDocuments.forEach(t=>this.Ta=this.Ta.delete(t)),this.current=e.current)}ya(){if(!this.current)return[];const e=this.da;this.da=Q(),this.Ra.forEach(r=>{this.Sa(r.key)&&(this.da=this.da.add(r.key))});const t=[];return e.forEach(r=>{this.da.has(r)||t.push(new Xm(r))}),this.da.forEach(r=>{e.has(r)||t.push(new Ym(r))}),t}ba(e){this.Ta=e.Ts,this.da=Q();const t=this.ma(e.documents);return this.applyChanges(t,!0)}Da(){return Gr.fromInitialDocuments(this.query,this.Ra,this.mutatedKeys,this.Ea===0,this.hasCachedResults)}}class ww{constructor(e,t,r){this.query=e,this.targetId=t,this.view=r}}class Aw{constructor(e){this.key=e,this.va=!1}}class Rw{constructor(e,t,r,i,s,o){this.localStore=e,this.remoteStore=t,this.eventManager=r,this.sharedClientState=i,this.currentUser=s,this.maxConcurrentLimboResolutions=o,this.Ca={},this.Fa=new Gt(c=>Gp(c),ws),this.Ma=new Map,this.xa=new Set,this.Oa=new ae(U.comparator),this.Na=new Map,this.La=new Cu,this.Ba={},this.ka=new Map,this.qa=rr.kn(),this.onlineState="Unknown",this.Qa=void 0}get isPrimaryClient(){return this.Qa===!0}}async function bw(n,e,t=!0){const r=ya(n);let i;const s=r.Fa.get(e);return s?(r.sharedClientState.addLocalQueryTarget(s.targetId),i=s.view.Da()):i=await eg(r,e,t,!0),i}async function Sw(n,e){const t=ya(n);await eg(t,e,!0,!1)}async function eg(n,e,t,r){const i=await qr(n.localStore,He(e)),s=i.targetId,o=n.sharedClientState.addLocalQueryTarget(s,t);let c;return r&&(c=await Gu(n,e,s,o==="current",i.resumeToken)),n.isPrimaryClient&&t&&_a(n.remoteStore,i),c}async function Gu(n,e,t,r,i){n.Ka=(p,g,T)=>async function(k,C,B,M){let O=C.view.ma(B);O.ns&&(O=await Ko(k.localStore,C.query,!1).then(({documents:E})=>C.view.ma(E,O)));const G=M&&M.targetChanges.get(C.targetId),W=M&&M.targetMismatches.get(C.targetId)!=null,$=C.view.applyChanges(O,k.isPrimaryClient,G,W);return Zc(k,C.targetId,$.wa),$.snapshot}(n,p,g,T);const s=await Ko(n.localStore,e,!0),o=new Zm(e,s.Ts),c=o.ma(s.documents),u=Ss.createSynthesizedTargetChangeForCurrentChange(t,r&&n.onlineState!=="Offline",i),l=o.applyChanges(c,n.isPrimaryClient,u);Zc(n,t,l.wa);const d=new ww(e,t,o);return n.Fa.set(e,d),n.Ma.has(t)?n.Ma.get(t).push(e):n.Ma.set(t,[e]),l.snapshot}async function Pw(n,e,t){const r=L(n),i=r.Fa.get(e),s=r.Ma.get(i.targetId);if(s.length>1)return r.Ma.set(i.targetId,s.filter(o=>!ws(o,e))),void r.Fa.delete(e);r.isPrimaryClient?(r.sharedClientState.removeLocalQueryTarget(i.targetId),r.sharedClientState.isActiveQueryTarget(i.targetId)||await jr(r.localStore,i.targetId,!1).then(()=>{r.sharedClientState.clearQueryState(i.targetId),t&&zr(r.remoteStore,i.targetId),$r(r,i.targetId)}).catch(bn)):($r(r,i.targetId),await jr(r.localStore,i.targetId,!0))}async function Cw(n,e){const t=L(n),r=t.Fa.get(e),i=t.Ma.get(r.targetId);t.isPrimaryClient&&i.length===1&&(t.sharedClientState.removeLocalQueryTarget(r.targetId),zr(t.remoteStore,r.targetId))}async function Dw(n,e,t){const r=Wu(n);try{const i=await function(o,c){const u=L(o),l=ge.now(),d=c.reduce((T,S)=>T.add(S.key),Q());let p,g;return u.persistence.runTransaction("Locally write mutations","readwrite",T=>{let S=tt(),k=Q();return u.cs.getEntries(T,d).next(C=>{S=C,S.forEach((B,M)=>{M.isValidDocument()||(k=k.add(B))})}).next(()=>u.localDocuments.getOverlayedDocuments(T,S)).next(C=>{p=C;const B=[];for(const M of c){const O=nv(M,p.get(M.key).overlayedDocument);O!=null&&B.push(new $t(M.key,O,Vp(O.value.mapValue),me.exists(!0)))}return u.mutationQueue.addMutationBatch(T,l,B,c)}).next(C=>{g=C;const B=C.applyToLocalDocumentSet(p,k);return u.documentOverlayCache.saveOverlays(T,C.batchId,B)})}).then(()=>({batchId:g.batchId,changes:Wp(p)}))}(r.localStore,e);r.sharedClientState.addPendingMutation(i.batchId),function(o,c,u){let l=o.Ba[o.currentUser.toKey()];l||(l=new ae(H)),l=l.insert(c,u),o.Ba[o.currentUser.toKey()]=l}(r,i.batchId,t),await Kt(r,i.changes),await ti(r.remoteStore)}catch(i){const s=ri(i,"Failed to persist write");t.reject(s)}}async function tg(n,e){const t=L(n);try{const r=await Wv(t.localStore,e);e.targetChanges.forEach((i,s)=>{const o=t.Na.get(s);o&&(z(i.addedDocuments.size+i.modifiedDocuments.size+i.removedDocuments.size<=1),i.addedDocuments.size>0?o.va=!0:i.modifiedDocuments.size>0?z(o.va):i.removedDocuments.size>0&&(z(o.va),o.va=!1))}),await Kt(t,r,e)}catch(r){await bn(r)}}function Qd(n,e,t){const r=L(n);if(r.isPrimaryClient&&t===0||!r.isPrimaryClient&&t===1){const i=[];r.Fa.forEach((s,o)=>{const c=o.view.Z_(e);c.snapshot&&i.push(c.snapshot)}),function(o,c){const u=L(o);u.onlineState=c;let l=!1;u.queries.forEach((d,p)=>{for(const g of p.j_)g.Z_(c)&&(l=!0)}),l&&ju(u)}(r.eventManager,e),i.length&&r.Ca.d_(i),r.onlineState=e,r.isPrimaryClient&&r.sharedClientState.setOnlineState(e)}}async function kw(n,e,t){const r=L(n);r.sharedClientState.updateQueryState(e,"rejected",t);const i=r.Na.get(e),s=i&&i.key;if(s){let o=new ae(U.comparator);o=o.insert(s,le.newNoDocument(s,K.min()));const c=Q().add(s),u=new bs(K.min(),new Map,new ae(H),o,c);await tg(r,u),r.Oa=r.Oa.remove(s),r.Na.delete(e),Hu(r)}else await jr(r.localStore,e,!1).then(()=>$r(r,e,t)).catch(bn)}async function Nw(n,e){const t=L(n),r=e.batch.batchId;try{const i=await Hv(t.localStore,e);Ku(t,r,null),$u(t,r),t.sharedClientState.updateMutationState(r,"acknowledged"),await Kt(t,i)}catch(i){await bn(i)}}async function Vw(n,e,t){const r=L(n);try{const i=await function(o,c){const u=L(o);return u.persistence.runTransaction("Reject batch","readwrite-primary",l=>{let d;return u.mutationQueue.lookupMutationBatch(l,c).next(p=>(z(p!==null),d=p.keys(),u.mutationQueue.removeMutationBatch(l,p))).next(()=>u.mutationQueue.performConsistencyCheck(l)).next(()=>u.documentOverlayCache.removeOverlaysForBatchId(l,d,c)).next(()=>u.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(l,d)).next(()=>u.localDocuments.getDocuments(l,d))})}(r.localStore,e);Ku(r,e,t),$u(r,e),r.sharedClientState.updateMutationState(e,"rejected",t),await Kt(r,i)}catch(i){await bn(i)}}async function Ow(n,e){const t=L(n);Cn(t.remoteStore)||V("SyncEngine","The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled.");try{const r=await function(o){const c=L(o);return c.persistence.runTransaction("Get highest unacknowledged batch id","readonly",u=>c.mutationQueue.getHighestUnacknowledgedBatchId(u))}(t.localStore);if(r===-1)return void e.resolve();const i=t.ka.get(r)||[];i.push(e),t.ka.set(r,i)}catch(r){const i=ri(r,"Initialization of waitForPendingWrites() operation failed");e.reject(i)}}function $u(n,e){(n.ka.get(e)||[]).forEach(t=>{t.resolve()}),n.ka.delete(e)}function Ku(n,e,t){const r=L(n);let i=r.Ba[r.currentUser.toKey()];if(i){const s=i.get(e);s&&(t?s.reject(t):s.resolve(),i=i.remove(e)),r.Ba[r.currentUser.toKey()]=i}}function $r(n,e,t=null){n.sharedClientState.removeLocalQueryTarget(e);for(const r of n.Ma.get(e))n.Fa.delete(r),t&&n.Ca.$a(r,t);n.Ma.delete(e),n.isPrimaryClient&&n.La.gr(e).forEach(r=>{n.La.containsKey(r)||ng(n,r)})}function ng(n,e){n.xa.delete(e.path.canonicalString());const t=n.Oa.get(e);t!==null&&(zr(n.remoteStore,t),n.Oa=n.Oa.remove(e),n.Na.delete(t),Hu(n))}function Zc(n,e,t){for(const r of t)r instanceof Ym?(n.La.addReference(r.key,e),xw(n,r)):r instanceof Xm?(V("SyncEngine","Document no longer in limbo: "+r.key),n.La.removeReference(r.key,e),n.La.containsKey(r.key)||ng(n,r.key)):j()}function xw(n,e){const t=e.key,r=t.path.canonicalString();n.Oa.get(t)||n.xa.has(r)||(V("SyncEngine","New document in limbo: "+t),n.xa.add(r),Hu(n))}function Hu(n){for(;n.xa.size>0&&n.Oa.size<n.maxConcurrentLimboResolutions;){const e=n.xa.values().next().value;n.xa.delete(e);const t=new U(X.fromString(e)),r=n.qa.next();n.Na.set(r,new Aw(t)),n.Oa=n.Oa.insert(t,r),_a(n.remoteStore,new Vt(He(Yr(t.path)),r,"TargetPurposeLimboResolution",Ze.oe))}}async function Kt(n,e,t){const r=L(n),i=[],s=[],o=[];r.Fa.isEmpty()||(r.Fa.forEach((c,u)=>{o.push(r.Ka(u,e,t).then(l=>{var d;if((l||t)&&r.isPrimaryClient){const p=l?!l.fromCache:(d=t==null?void 0:t.targetChanges.get(u.targetId))===null||d===void 0?void 0:d.current;r.sharedClientState.updateQueryState(u.targetId,p?"current":"not-current")}if(l){i.push(l);const p=Vu.Wi(u.targetId,l);s.push(p)}}))}),await Promise.all(o),r.Ca.d_(i),await async function(u,l){const d=L(u);try{await d.persistence.runTransaction("notifyLocalViewChanges","readwrite",p=>A.forEach(l,g=>A.forEach(g.$i,T=>d.persistence.referenceDelegate.addReference(p,g.targetId,T)).next(()=>A.forEach(g.Ui,T=>d.persistence.referenceDelegate.removeReference(p,g.targetId,T)))))}catch(p){if(!Sn(p))throw p;V("LocalStore","Failed to update sequence numbers: "+p)}for(const p of l){const g=p.targetId;if(!p.fromCache){const T=d.os.get(g),S=T.snapshotVersion,k=T.withLastLimboFreeSnapshotVersion(S);d.os=d.os.insert(g,k)}}}(r.localStore,s))}async function Lw(n,e){const t=L(n);if(!t.currentUser.isEqual(e)){V("SyncEngine","User change. New user:",e.toKey());const r=await Lm(t.localStore,e);t.currentUser=e,function(s,o){s.ka.forEach(c=>{c.forEach(u=>{u.reject(new N(P.CANCELLED,o))})}),s.ka.clear()}(t,"'waitForPendingWrites' promise is rejected due to a user change."),t.sharedClientState.handleUserChange(e,r.removedBatchIds,r.addedBatchIds),await Kt(t,r.hs)}}function Mw(n,e){const t=L(n),r=t.Na.get(e);if(r&&r.va)return Q().add(r.key);{let i=Q();const s=t.Ma.get(e);if(!s)return i;for(const o of s){const c=t.Fa.get(o);i=i.unionWith(c.view.Va)}return i}}async function Fw(n,e){const t=L(n),r=await Ko(t.localStore,e.query,!0),i=e.view.ba(r);return t.isPrimaryClient&&Zc(t,e.targetId,i.wa),i}async function Uw(n,e){const t=L(n);return Bm(t.localStore,e).then(r=>Kt(t,r))}async function Bw(n,e,t,r){const i=L(n),s=await function(c,u){const l=L(c),d=L(l.mutationQueue);return l.persistence.runTransaction("Lookup mutation documents","readonly",p=>d.Mn(p,u).next(g=>g?l.localDocuments.getDocuments(p,g):A.resolve(null)))}(i.localStore,e);s!==null?(t==="pending"?await ti(i.remoteStore):t==="acknowledged"||t==="rejected"?(Ku(i,e,r||null),$u(i,e),function(c,u){L(L(c).mutationQueue).On(u)}(i.localStore,e)):j(),await Kt(i,s)):V("SyncEngine","Cannot apply mutation batch with id: "+e)}async function qw(n,e){const t=L(n);if(ya(t),Wu(t),e===!0&&t.Qa!==!0){const r=t.sharedClientState.getAllActiveQueryTargets(),i=await Jd(t,r.toArray());t.Qa=!0,await Yc(t.remoteStore,!0);for(const s of i)_a(t.remoteStore,s)}else if(e===!1&&t.Qa!==!1){const r=[];let i=Promise.resolve();t.Ma.forEach((s,o)=>{t.sharedClientState.isLocalQueryTarget(o)?r.push(o):i=i.then(()=>($r(t,o),jr(t.localStore,o,!0))),zr(t.remoteStore,o)}),await i,await Jd(t,r),function(o){const c=L(o);c.Na.forEach((u,l)=>{zr(c.remoteStore,l)}),c.La.pr(),c.Na=new Map,c.Oa=new ae(U.comparator)}(t),t.Qa=!1,await Yc(t.remoteStore,!1)}}async function Jd(n,e,t){const r=L(n),i=[],s=[];for(const o of e){let c;const u=r.Ma.get(o);if(u&&u.length!==0){c=await qr(r.localStore,He(u[0]));for(const l of u){const d=r.Fa.get(l),p=await Fw(r,d);p.snapshot&&s.push(p.snapshot)}}else{const l=await Um(r.localStore,o);c=await qr(r.localStore,l),await Gu(r,rg(l),o,!1,c.resumeToken)}i.push(c)}return r.Ca.d_(s),i}function rg(n){return qp(n.path,n.collectionGroup,n.orderBy,n.filters,n.limit,"F",n.startAt,n.endAt)}function jw(n){return function(t){return L(L(t).persistence).Qi()}(L(n).localStore)}async function zw(n,e,t,r){const i=L(n);if(i.Qa)return void V("SyncEngine","Ignoring unexpected query state notification.");const s=i.Ma.get(e);if(s&&s.length>0)switch(t){case"current":case"not-current":{const o=await Bm(i.localStore,$p(s[0])),c=bs.createSynthesizedRemoteEventForCurrentChange(e,t==="current",Ie.EMPTY_BYTE_STRING);await Kt(i,o,c);break}case"rejected":await jr(i.localStore,e,!0),$r(i,e,r);break;default:j()}}async function Gw(n,e,t){const r=ya(n);if(r.Qa){for(const i of e){if(r.Ma.has(i)&&r.sharedClientState.isActiveQueryTarget(i)){V("SyncEngine","Adding an already active target "+i);continue}const s=await Um(r.localStore,i),o=await qr(r.localStore,s);await Gu(r,rg(s),o.targetId,!1,o.resumeToken),_a(r.remoteStore,o)}for(const i of t)r.Ma.has(i)&&await jr(r.localStore,i,!1).then(()=>{zr(r.remoteStore,i),$r(r,i)}).catch(bn)}}function ya(n){const e=L(n);return e.remoteStore.remoteSyncer.applyRemoteEvent=tg.bind(null,e),e.remoteStore.remoteSyncer.getRemoteKeysForTarget=Mw.bind(null,e),e.remoteStore.remoteSyncer.rejectListen=kw.bind(null,e),e.Ca.d_=Iw.bind(null,e.eventManager),e.Ca.$a=Tw.bind(null,e.eventManager),e}function Wu(n){const e=L(n);return e.remoteStore.remoteSyncer.applySuccessfulWrite=Nw.bind(null,e),e.remoteStore.remoteSyncer.rejectFailedWrite=Vw.bind(null,e),e}function $w(n,e,t){const r=L(n);(async function(s,o,c){try{const u=await o.getMetadata();if(await function(T,S){const k=L(T),C=be(S.createTime);return k.persistence.runTransaction("hasNewerBundle","readonly",B=>k.Gr.getBundleMetadata(B,S.id)).then(B=>!!B&&B.createTime.compareTo(C)>=0)}(s.localStore,u))return await o.close(),c._completeWith(function(T){return{taskState:"Success",documentsLoaded:T.totalDocuments,bytesLoaded:T.totalBytes,totalDocuments:T.totalDocuments,totalBytes:T.totalBytes}}(u)),Promise.resolve(new Set);c._updateProgress(Jm(u));const l=new vw(u,s.localStore,o.serializer);let d=await o.Ua();for(;d;){const g=await l.la(d);g&&c._updateProgress(g),d=await o.Ua()}const p=await l.complete();return await Kt(s,p.Ia,void 0),await function(T,S){const k=L(T);return k.persistence.runTransaction("Save bundle","readwrite",C=>k.Gr.saveBundleMetadata(C,S))}(s.localStore,u),c._completeWith(p.progress),Promise.resolve(p.Pa)}catch(u){return it("SyncEngine",`Loading bundle failed with ${u}`),c._failWith(u),Promise.resolve(new Set)}})(r,e,t).then(i=>{r.sharedClientState.notifyBundleLoaded(i)})}class vn{constructor(){this.kind="memory",this.synchronizeTabs=!1}async initialize(e){this.serializer=Ps(e.databaseInfo.databaseId),this.sharedClientState=this.Wa(e),this.persistence=this.Ga(e),await this.persistence.start(),this.localStore=this.za(e),this.gcScheduler=this.ja(e,this.localStore),this.indexBackfillerScheduler=this.Ha(e,this.localStore)}ja(e,t){return null}Ha(e,t){return null}za(e){return xm(this.persistence,new Om,e.initialUser,this.serializer)}Ga(e){return new Du(ga.Zr,this.serializer)}Wa(e){return new jm}async terminate(){var e,t;(e=this.gcScheduler)===null||e===void 0||e.stop(),(t=this.indexBackfillerScheduler)===null||t===void 0||t.stop(),this.sharedClientState.shutdown(),await this.persistence.shutdown()}}vn.provider={build:()=>new vn};class Kw extends vn{constructor(e){super(),this.cacheSizeBytes=e}ja(e,t){z(this.persistence.referenceDelegate instanceof $o);const r=this.persistence.referenceDelegate.garbageCollector;return new Cm(r,e.asyncQueue,t)}Ga(e){const t=this.cacheSizeBytes!==void 0?Ge.withCacheSize(this.cacheSizeBytes):Ge.DEFAULT;return new Du(r=>$o.Zr(r,t),this.serializer)}}class Qu extends vn{constructor(e,t,r){super(),this.Ja=e,this.cacheSizeBytes=t,this.forceOwnership=r,this.kind="persistent",this.synchronizeTabs=!1}async initialize(e){await super.initialize(e),await this.Ja.initialize(this,e),await Wu(this.Ja.syncEngine),await ti(this.Ja.remoteStore),await this.persistence.yi(()=>(this.gcScheduler&&!this.gcScheduler.started&&this.gcScheduler.start(),this.indexBackfillerScheduler&&!this.indexBackfillerScheduler.started&&this.indexBackfillerScheduler.start(),Promise.resolve()))}za(e){return xm(this.persistence,new Om,e.initialUser,this.serializer)}ja(e,t){const r=this.persistence.referenceDelegate.garbageCollector;return new Cm(r,e.asyncQueue,t)}Ha(e,t){const r=new fE(t,this.persistence);return new dE(e.asyncQueue,r)}Ga(e){const t=Nu(e.databaseInfo.databaseId,e.databaseInfo.persistenceKey),r=this.cacheSizeBytes!==void 0?Ge.withCacheSize(this.cacheSizeBytes):Ge.DEFAULT;return new ku(this.synchronizeTabs,t,e.clientId,r,e.asyncQueue,zm(),Co(),this.serializer,this.sharedClientState,!!this.forceOwnership)}Wa(e){return new jm}}class ig extends Qu{constructor(e,t){super(e,t,!1),this.Ja=e,this.cacheSizeBytes=t,this.synchronizeTabs=!0}async initialize(e){await super.initialize(e);const t=this.Ja.syncEngine;this.sharedClientState instanceof Ic&&(this.sharedClientState.syncEngine={no:Bw.bind(null,t),ro:zw.bind(null,t),io:Gw.bind(null,t),Qi:jw.bind(null,t),eo:Uw.bind(null,t)},await this.sharedClientState.start()),await this.persistence.yi(async r=>{await qw(this.Ja.syncEngine,r),this.gcScheduler&&(r&&!this.gcScheduler.started?this.gcScheduler.start():r||this.gcScheduler.stop()),this.indexBackfillerScheduler&&(r&&!this.indexBackfillerScheduler.started?this.indexBackfillerScheduler.start():r||this.indexBackfillerScheduler.stop())})}Wa(e){const t=zm();if(!Ic.D(t))throw new N(P.UNIMPLEMENTED,"IndexedDB persistence is only available on platforms that support LocalStorage.");const r=Nu(e.databaseInfo.databaseId,e.databaseInfo.persistenceKey);return new Ic(t,e.asyncQueue,r,e.clientId,e.initialUser)}}class wn{async initialize(e,t){this.localStore||(this.localStore=e.localStore,this.sharedClientState=e.sharedClientState,this.datastore=this.createDatastore(t),this.remoteStore=this.createRemoteStore(t),this.eventManager=this.createEventManager(t),this.syncEngine=this.createSyncEngine(t,!e.synchronizeTabs),this.sharedClientState.onlineStateHandler=r=>Qd(this.syncEngine,r,1),this.remoteStore.remoteSyncer.handleCredentialChange=Lw.bind(null,this.syncEngine),await Yc(this.remoteStore,this.syncEngine.isPrimaryClient))}createEventManager(e){return function(){return new yw}()}createDatastore(e){const t=Ps(e.databaseInfo.databaseId),r=function(s){return new tw(s)}(e.databaseInfo);return function(s,o,c,u){return new iw(s,o,c,u)}(e.authCredentials,e.appCheckCredentials,r,t)}createRemoteStore(e){return function(r,i,s,o,c){return new ow(r,i,s,o,c)}(this.localStore,this.datastore,e.asyncQueue,t=>Qd(this.syncEngine,t,0),function(){return zd.D()?new zd:new Xv}())}createSyncEngine(e,t){return function(i,s,o,c,u,l,d){const p=new Rw(i,s,o,c,u,l);return d&&(p.Qa=!0),p}(this.localStore,this.remoteStore,this.eventManager,this.sharedClientState,e.initialUser,e.maxConcurrentLimboResolutions,t)}async terminate(){var e,t;await async function(i){const s=L(i);V("RemoteStore","RemoteStore shutting down."),s.L_.add(5),await ei(s),s.k_.shutdown(),s.q_.set("Unknown")}(this.remoteStore),(e=this.datastore)===null||e===void 0||e.terminate(),(t=this.eventManager)===null||t===void 0||t.terminate()}}wn.provider={build:()=>new wn};function Yd(n,e=10240){let t=0;return{async read(){if(t<n.byteLength){const r={value:n.slice(t,t+e),done:!1};return t+=e,r}return{done:!0}},async cancel(){},releaseLock(){},closed:Promise.resolve()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ia{constructor(e){this.observer=e,this.muted=!1}next(e){this.muted||this.observer.next&&this.Ya(this.observer.next,e)}error(e){this.muted||(this.observer.error?this.Ya(this.observer.error,e):Re("Uncaught Error in snapshot listener:",e.toString()))}Za(){this.muted=!0}Ya(e,t){setTimeout(()=>{this.muted||e(t)},0)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Xu(n,e,t){if(!t)throw new N(P.INVALID_ARGUMENT,`Function ${n}() cannot be called with an empty ${e}.`)}function hg(n,e,t,r){if(e===!0&&r===!0)throw new N(P.INVALID_ARGUMENT,`${n} and ${t} cannot be used together.`)}function ef(n){if(!U.isDocumentKey(n))throw new N(P.INVALID_ARGUMENT,`Invalid document reference. Document references must have an even number of segments, but ${n} has ${n.length}.`)}function tf(n){if(U.isDocumentKey(n))throw new N(P.INVALID_ARGUMENT,`Invalid collection reference. Collection references must have an odd number of segments, but ${n} has ${n.length}.`)}function Ea(n){if(n===void 0)return"undefined";if(n===null)return"null";if(typeof n=="string")return n.length>20&&(n=`${n.substring(0,20)}...`),JSON.stringify(n);if(typeof n=="number"||typeof n=="boolean")return""+n;if(typeof n=="object"){if(n instanceof Array)return"an array";{const e=function(r){return r.constructor?r.constructor.name:null}(n);return e?`a custom ${e} object`:"an object"}}return typeof n=="function"?"a function":j()}function J(n,e){if("_delegate"in n&&(n=n._delegate),!(n instanceof e)){if(e.name===n.constructor.name)throw new N(P.INVALID_ARGUMENT,"Type does not match the expected instance. Did you pass a reference from a different Firestore SDK?");{const t=Ea(n);throw new N(P.INVALID_ARGUMENT,`Expected type '${e.name}', but it was: ${t}`)}}return n}function dg(n,e){if(e<=0)throw new N(P.INVALID_ARGUMENT,`Function ${n}() requires a positive number, but it was: ${e}.`)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xe{constructor(e,t,r){this.converter=t,this._query=r,this.type="query",this.firestore=e}withConverter(e){return new xe(this.firestore,e,this._query)}}class ve{constructor(e,t,r){this.converter=t,this._key=r,this.type="document",this.firestore=e}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new dt(this.firestore,this.converter,this._key.path.popLast())}withConverter(e){return new ve(this.firestore,e,this._key)}}class dt extends xe{constructor(e,t,r){super(e,t,Yr(r)),this._path=r,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const e=this._path.popLast();return e.isEmpty()?null:new ve(this.firestore,null,new U(e))}withConverter(e){return new dt(this.firestore,e,this._path)}}function cA(n,e,...t){if(n=q(n),Xu("collection","path",e),n instanceof Ds){const r=X.fromString(e,...t);return tf(r),new dt(n,null,r)}{if(!(n instanceof ve||n instanceof dt))throw new N(P.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=n._path.child(X.fromString(e,...t));return tf(r),new dt(n.firestore,null,r)}}function uA(n,e){if(n=J(n,Ds),Xu("collectionGroup","collection id",e),e.indexOf("/")>=0)throw new N(P.INVALID_ARGUMENT,`Invalid collection ID '${e}' passed to function collectionGroup(). Collection IDs must not contain '/'.`);return new xe(n,null,function(r){return new zt(X.emptyPath(),r)}(e))}function pg(n,e,...t){if(n=q(n),arguments.length===1&&(e=du.newId()),Xu("doc","path",e),n instanceof Ds){const r=X.fromString(e,...t);return ef(r),new ve(n,null,new U(r))}{if(!(n instanceof ve||n instanceof dt))throw new N(P.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=n._path.child(X.fromString(e,...t));return ef(r),new ve(n.firestore,n instanceof dt?n.converter:null,new U(r))}}function lA(n,e){return n=q(n),e=q(e),(n instanceof ve||n instanceof dt)&&(e instanceof ve||e instanceof dt)&&n.firestore===e.firestore&&n.path===e.path&&n.converter===e.converter}function Zu(n,e){return n=q(n),e=q(e),n instanceof xe&&e instanceof xe&&n.firestore===e.firestore&&ws(n._query,e._query)&&n.converter===e.converter}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class va{constructor(e,t){if(!isFinite(e)||e<-90||e>90)throw new N(P.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(t)||t<-180||t>180)throw new N(P.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+t);this._lat=e,this._long=t}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}toJSON(){return{latitude:this._lat,longitude:this._long}}_compareTo(e){return H(this._lat,e._lat)||H(this._long,e._long)}}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const AA=/^__.*__$/;class RA{constructor(e,t,r){this.data=e,this.fieldMask=t,this.fieldTransforms=r}toMutation(e,t){return this.fieldMask!==null?new $t(e,this.data,this.fieldMask,t,this.fieldTransforms):new Xr(e,this.data,t,this.fieldTransforms)}}class Ig{constructor(e,t,r){this.data=e,this.fieldMask=t,this.fieldTransforms=r}toMutation(e,t){return new $t(e,this.data,this.fieldMask,t,this.fieldTransforms)}}function Tg(n){switch(n){case 0:case 2:case 1:return!0;case 3:case 4:return!1;default:throw j()}}class wa{constructor(e,t,r,i,s,o){this.settings=e,this.databaseId=t,this.serializer=r,this.ignoreUndefinedProperties=i,s===void 0&&this.vu(),this.fieldTransforms=s||[],this.fieldMask=o||[]}get path(){return this.settings.path}get Cu(){return this.settings.Cu}Fu(e){return new wa(Object.assign(Object.assign({},this.settings),e),this.databaseId,this.serializer,this.ignoreUndefinedProperties,this.fieldTransforms,this.fieldMask)}Mu(e){var t;const r=(t=this.path)===null||t===void 0?void 0:t.child(e),i=this.Fu({path:r,xu:!1});return i.Ou(e),i}Nu(e){var t;const r=(t=this.path)===null||t===void 0?void 0:t.child(e),i=this.Fu({path:r,xu:!1});return i.vu(),i}Lu(e){return this.Fu({path:void 0,xu:!0})}Bu(e){return Jo(e,this.settings.methodName,this.settings.ku||!1,this.path,this.settings.qu)}contains(e){return this.fieldMask.find(t=>e.isPrefixOf(t))!==void 0||this.fieldTransforms.find(t=>e.isPrefixOf(t.field))!==void 0}vu(){if(this.path)for(let e=0;e<this.path.length;e++)this.Ou(this.path.get(e))}Ou(e){if(e.length===0)throw this.Bu("Document fields must not be empty");if(Tg(this.Cu)&&AA.test(e))throw this.Bu('Document fields cannot begin and end with "__"')}}class bA{constructor(e,t,r){this.databaseId=e,this.ignoreUndefinedProperties=t,this.serializer=r||Ps(e)}Qu(e,t,r,i=!1){return new wa({Cu:e,methodName:t,qu:r,path:he.emptyPath(),xu:!1,ku:i},this.databaseId,this.serializer,this.ignoreUndefinedProperties)}}function cr(n){const e=n._freezeSettings(),t=Ps(n._databaseId);return new bA(n._databaseId,!!e.ignoreUndefinedProperties,t)}function Aa(n,e,t,r,i,s={}){const o=n.Qu(s.merge||s.mergeFields?2:0,e,t,i);ol("Data must be an object, but it was:",o,r);const c=wg(r,o);let u,l;if(s.merge)u=new et(o.fieldMask),l=o.fieldTransforms;else if(s.mergeFields){const d=[];for(const p of s.mergeFields){const g=fs(e,p,t);if(!o.contains(g))throw new N(P.INVALID_ARGUMENT,`Field '${g}' is specified in your field mask but missing from your input data.`);Rg(d,g)||d.push(g)}u=new et(d),l=o.fieldTransforms.filter(p=>u.covers(p.field))}else u=null,l=o.fieldTransforms;return new RA(new Fe(c),u,l)}class Ns extends kn{_toFieldTransform(e){if(e.Cu!==2)throw e.Cu===1?e.Bu(`${this._methodName}() can only appear at the top level of your update data`):e.Bu(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`);return e.fieldMask.push(e.path),null}isEqual(e){return e instanceof Ns}}function Eg(n,e,t){return new wa({Cu:3,qu:e.settings.qu,methodName:n._methodName,xu:t},e.databaseId,e.serializer,e.ignoreUndefinedProperties)}class el extends kn{_toFieldTransform(e){return new Rs(e.path,new Fr)}isEqual(e){return e instanceof el}}class tl extends kn{constructor(e,t){super(e),this.Ku=t}_toFieldTransform(e){const t=Eg(this,e,!0),r=this.Ku.map(s=>ur(s,t)),i=new Zn(r);return new Rs(e.path,i)}isEqual(e){return e instanceof tl&&dn(this.Ku,e.Ku)}}class nl extends kn{constructor(e,t){super(e),this.Ku=t}_toFieldTransform(e){const t=Eg(this,e,!0),r=this.Ku.map(s=>ur(s,t)),i=new er(r);return new Rs(e.path,i)}isEqual(e){return e instanceof nl&&dn(this.Ku,e.Ku)}}class rl extends kn{constructor(e,t){super(e),this.$u=t}_toFieldTransform(e){const t=new Ur(e.serializer,Yp(e.serializer,this.$u));return new Rs(e.path,t)}isEqual(e){return e instanceof rl&&this.$u===e.$u}}function il(n,e,t,r){const i=n.Qu(1,e,t);ol("Data must be an object, but it was:",i,r);const s=[],o=Fe.empty();Pn(r,(u,l)=>{const d=Ra(e,u,t);l=q(l);const p=i.Nu(d);if(l instanceof Ns)s.push(d);else{const g=ur(l,p);g!=null&&(s.push(d),o.set(d,g))}});const c=new et(s);return new Ig(o,c,i.fieldTransforms)}function sl(n,e,t,r,i,s){const o=n.Qu(1,e,t),c=[fs(e,r,t)],u=[i];if(s.length%2!=0)throw new N(P.INVALID_ARGUMENT,`Function ${e}() needs to be called with an even number of arguments that alternate between field names and values.`);for(let g=0;g<s.length;g+=2)c.push(fs(e,s[g])),u.push(s[g+1]);const l=[],d=Fe.empty();for(let g=c.length-1;g>=0;--g)if(!Rg(l,c[g])){const T=c[g];let S=u[g];S=q(S);const k=o.Nu(T);if(S instanceof Ns)l.push(T);else{const C=ur(S,k);C!=null&&(l.push(T),d.set(T,C))}}const p=new et(l);return new Ig(d,p,o.fieldTransforms)}function vg(n,e,t,r=!1){return ur(t,n.Qu(r?4:3,e))}function ur(n,e){if(Ag(n=q(n)))return ol("Unsupported field value:",e,n),wg(n,e);if(n instanceof kn)return function(r,i){if(!Tg(i.Cu))throw i.Bu(`${r._methodName}() can only be used with update() and set()`);if(!i.path)throw i.Bu(`${r._methodName}() is not currently supported inside arrays`);const s=r._toFieldTransform(i);s&&i.fieldTransforms.push(s)}(n,e),null;if(n===void 0&&e.ignoreUndefinedProperties)return null;if(e.path&&e.fieldMask.push(e.path),n instanceof Array){if(e.settings.xu&&e.Cu!==4)throw e.Bu("Nested arrays are not supported");return function(r,i){const s=[];let o=0;for(const c of r){let u=ur(c,i.Lu(o));u==null&&(u={nullValue:"NULL_VALUE"}),s.push(u),o++}return{arrayValue:{values:s}}}(n,e)}return function(r,i){if((r=q(r))===null)return{nullValue:"NULL_VALUE"};if(typeof r=="number")return Yp(i.serializer,r);if(typeof r=="boolean")return{booleanValue:r};if(typeof r=="string")return{stringValue:r};if(r instanceof Date){const s=ge.fromDate(r);return{timestampValue:Br(i.serializer,s)}}if(r instanceof ge){const s=new ge(r.seconds,1e3*Math.floor(r.nanoseconds/1e3));return{timestampValue:Br(i.serializer,s)}}if(r instanceof va)return{geoPointValue:{latitude:r.latitude,longitude:r.longitude}};if(r instanceof An)return{bytesValue:lm(i.serializer,r._byteString)};if(r instanceof ve){const s=i.databaseId,o=r.firestore._databaseId;if(!o.isEqual(s))throw i.Bu(`Document reference is for database ${o.projectId}/${o.database} but should be for database ${s.projectId}/${s.database}`);return{referenceValue:Ru(r.firestore._databaseId||i.databaseId,r._key.path)}}if(r instanceof ks)return function(o,c){return{mapValue:{fields:{__type__:{stringValue:"__vector__"},value:{arrayValue:{values:o.toArray().map(u=>{if(typeof u!="number")throw c.Bu("VectorValues must only contain numeric values.");return Iu(c.serializer,u)})}}}}}}(r,i);throw i.Bu(`Unsupported field value: ${Ea(r)}`)}(n,e)}function wg(n,e){const t={};return Cp(n)?e.path&&e.path.length>0&&e.fieldMask.push(e.path):Pn(n,(r,i)=>{const s=ur(i,e.Mu(r));s!=null&&(t[r]=s)}),{mapValue:{fields:t}}}function Ag(n){return!(typeof n!="object"||n===null||n instanceof Array||n instanceof Date||n instanceof ge||n instanceof va||n instanceof An||n instanceof ve||n instanceof kn||n instanceof ks)}function ol(n,e,t){if(!Ag(t)||!function(i){return typeof i=="object"&&i!==null&&(Object.getPrototypeOf(i)===Object.prototype||Object.getPrototypeOf(i)===null)}(t)){const r=Ea(t);throw r==="an object"?e.Bu(n+" a custom object"):e.Bu(n+" "+r)}}function fs(n,e,t){if((e=q(e))instanceof Dn)return e._internalPath;if(typeof e=="string")return Ra(n,e);throw Jo("Field path arguments must be of type string or ",n,!1,void 0,t)}const SA=new RegExp("[~\\*/\\[\\]]");function Ra(n,e,t){if(e.search(SA)>=0)throw Jo(`Invalid field path (${e}). Paths must not contain '~', '*', '/', '[', or ']'`,n,!1,void 0,t);try{return new Dn(...e.split("."))._internalPath}catch{throw Jo(`Invalid field path (${e}). Paths must not be empty, begin with '.', end with '.', or contain '..'`,n,!1,void 0,t)}}function Jo(n,e,t,r,i){const s=r&&!r.isEmpty(),o=i!==void 0;let c=`Function ${e}() called with invalid data`;t&&(c+=" (via `toFirestore()`)"),c+=". ";let u="";return(s||o)&&(u+=" (found",s&&(u+=` in field ${r}`),o&&(u+=` in document ${i}`),u+=")"),new N(P.INVALID_ARGUMENT,c+n+u)}function Rg(n,e){return n.some(t=>t.isEqual(e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Pa(n,e,t){let r;return r=n?t&&(t.merge||t.mergeFields)?n.toFirestore(e,t):n.toFirestore(e):e,r}class BA extends cl{constructor(e){super(),this.firestore=e}convertBytes(e){return new An(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new ve(this.firestore,null,t)}}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function qA(n){return new Hr("sum",fs("sum",n))}function jA(n){return new Hr("avg",fs("average",n))}function Dg(){return new Hr("count")}function zA(n,e){var t,r;return n instanceof Hr&&e instanceof Hr&&n.aggregateType===e.aggregateType&&((t=n._internalFieldPath)===null||t===void 0?void 0:t.canonicalString())===((r=e._internalFieldPath)===null||r===void 0?void 0:r.canonicalString())}function GA(n,e){return Zu(n.query,e.query)&&dn(n.data(),e.data())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function HA(n){n=J(n,ve);const e=J(n.firestore,se);return cg(_e(e),n._key).then(t=>ul(e,n,t))}class Nn extends cl{constructor(e){super(),this.firestore=e}convertBytes(e){return new An(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new ve(this.firestore,null,t)}}function WA(n){n=J(n,ve);const e=J(n.firestore,se),t=_e(e),r=new Nn(e);return Zw(t,n._key).then(i=>new ir(e,r,n._key,i,new cn(i!==null&&i.hasLocalMutations,!0),n.converter))}function QA(n){n=J(n,ve);const e=J(n.firestore,se);return cg(_e(e),n._key,{source:"server"}).then(t=>ul(e,n,t))}function JA(n){n=J(n,xe);const e=J(n.firestore,se),t=_e(e),r=new Nn(e);return bg(n._query),ug(t,n._query).then(i=>new sr(e,r,n,i))}function YA(n){n=J(n,xe);const e=J(n.firestore,se),t=_e(e),r=new Nn(e);return eA(t,n._query).then(i=>new sr(e,r,n,i))}function XA(n){n=J(n,xe);const e=J(n.firestore,se),t=_e(e),r=new Nn(e);return ug(t,n._query,{source:"server"}).then(i=>new sr(e,r,n,i))}function ZA(n,e,t){n=J(n,ve);const r=J(n.firestore,se),i=Pa(n.converter,e,t);return ai(r,[Aa(cr(r),"setDoc",n._key,i,n.converter!==null,t).toMutation(n._key,me.none())])}function eR(n,e,t,...r){n=J(n,ve);const i=J(n.firestore,se),s=cr(i);let o;return o=typeof(e=q(e))=="string"||e instanceof Dn?sl(s,"updateDoc",n._key,e,t,r):il(s,"updateDoc",n._key,e),ai(i,[o.toMutation(n._key,me.exists(!0))])}function tR(n){return ai(J(n.firestore,se),[new Zr(n._key,me.none())])}function nR(n,e){const t=J(n.firestore,se),r=pg(n),i=Pa(n.converter,e);return ai(t,[Aa(cr(n.firestore),"addDoc",r._key,i,n.converter!==null,{}).toMutation(r._key,me.exists(!1))]).then(()=>r)}function rR(n,...e){var t,r,i;n=q(n);let s={includeMetadataChanges:!1,source:"default"},o=0;typeof e[o]!="object"||eu(e[o])||(s=e[o],o++);const c={includeMetadataChanges:s.includeMetadataChanges,source:s.source};if(eu(e[o])){const p=e[o];e[o]=(t=p.next)===null||t===void 0?void 0:t.bind(p),e[o+1]=(r=p.error)===null||r===void 0?void 0:r.bind(p),e[o+2]=(i=p.complete)===null||i===void 0?void 0:i.bind(p)}let u,l,d;if(n instanceof ve)l=J(n.firestore,se),d=Yr(n._key.path),u={next:p=>{e[o]&&e[o](ul(l,n,p))},error:e[o+1],complete:e[o+2]};else{const p=J(n,xe);l=J(p.firestore,se),d=p._query;const g=new Nn(l);u={next:T=>{e[o]&&e[o](new sr(l,g,p,T))},error:e[o+1],complete:e[o+2]},bg(n._query)}return function(g,T,S,k){const C=new Ia(k),B=new zu(T,C,S);return g.asyncQueue.enqueueAndForget(async()=>Bu(await Kr(g),B)),()=>{C.Za(),g.asyncQueue.enqueueAndForget(async()=>qu(await Kr(g),B))}}(_e(l),d,c,u)}function iR(n,e){return nA(_e(n=J(n,se)),eu(e)?e:{next:e})}function ai(n,e){return function(r,i){const s=new Ve;return r.asyncQueue.enqueueAndForget(async()=>Dw(await Yu(r),i,s)),s.promise}(_e(n),e)}function ul(n,e,t){const r=t.docs.get(e._key),i=new Nn(n);return new ir(n,i,e._key,r,new cn(t.hasPendingWrites,t.fromCache),e.converter)}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Og extends class{constructor(t,r){this._firestore=t,this._transaction=r,this._dataReader=cr(t)}get(t){const r=on(t,this._firestore),i=new BA(this._firestore);return this._transaction.lookup([r._key]).then(s=>{if(!s||s.length!==1)return j();const o=s[0];if(o.isFoundDocument())return new ps(this._firestore,i,o.key,o,r.converter);if(o.isNoDocument())return new ps(this._firestore,i,r._key,null,r.converter);throw j()})}set(t,r,i){const s=on(t,this._firestore),o=Pa(s.converter,r,i),c=Aa(this._dataReader,"Transaction.set",s._key,o,s.converter!==null,i);return this._transaction.set(s._key,c),this}update(t,r,i,...s){const o=on(t,this._firestore);let c;return c=typeof(r=q(r))=="string"||r instanceof Dn?sl(this._dataReader,"Transaction.update",o._key,r,i,s):il(this._dataReader,"Transaction.update",o._key,r),this._transaction.update(o._key,c),this}delete(t){const r=on(t,this._firestore);return this._transaction.delete(r._key),this}}{constructor(e,t){super(e,t),this._firestore=e}get(e){const t=on(e,this._firestore),r=new Nn(this._firestore);return super.get(e).then(i=>new ir(this._firestore,r,t._key,i._document,new cn(!1,!1),t.converter))}}function yR(n,e,t){n=J(n,se);const r=Object.assign(Object.assign({},_R),t);return function(s){if(s.maxAttempts<1)throw new N(P.INVALID_ARGUMENT,"Max attempts must be at least 1")}(r),function(s,o,c){const u=new Ve;return s.asyncQueue.enqueueAndForget(async()=>{const l=await ag(s);new Qw(s.asyncQueue,l,c,o,u).au()}),u.promise}(_e(n),i=>e(new Og(n,i)),r)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function IR(){return new Ns("deleteField")}function TR(){return new el("serverTimestamp")}function ER(...n){return new tl("arrayUnion",n)}function vR(...n){return new nl("arrayRemove",n)}function wR(n){return new rl("increment",n)}function AR(n){return new ks(n)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function bR(n,e){const t=_e(n=J(n,se));if(!t._uninitializedComponentsProvider||t._uninitializedComponentsProvider._offline.kind==="memory")return it("Cannot enable indexes when persistence is disabled"),Promise.resolve();const r=function(s){const o=typeof s=="string"?function(l){try{return JSON.parse(l)}catch(d){throw new N(P.INVALID_ARGUMENT,"Failed to parse JSON: "+(d==null?void 0:d.message))}}(s):s,c=[];if(Array.isArray(o.indexes))for(const u of o.indexes){const l=af(u,"collectionGroup"),d=[];if(Array.isArray(u.fields))for(const p of u.fields){const g=Ra("setIndexConfiguration",af(p,"fieldPath"));p.arrayConfig==="CONTAINS"?d.push(new Wn(g,2)):p.order==="ASCENDING"?d.push(new Wn(g,0)):p.order==="DESCENDING"&&d.push(new Wn(g,1))}c.push(new Or(Or.UNKNOWN_ID,l,d,xr.empty()))}return c}(e);return sA(t,r)}function af(n,e){if(typeof n[e]!="string")throw new N(P.INVALID_ARGUMENT,"Missing string value for: "+e);return n[e]}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class VR{constructor(){throw new Error("instances of this class should not be created")}static onExistenceFilterMismatch(e){return ll.instance.onExistenceFilterMismatch(e)}}class ll{constructor(){this.Uu=new Map}static get instance(){return po||(po=new ll,function(t){if(qo)throw new Error("a TestingHooksSpi instance is already set");qo=t}(po)),po}et(e){this.Uu.forEach(t=>t(e))}onExistenceFilterMismatch(e){const t=Symbol(),r=this.Uu;return r.set(t,e),()=>r.delete(t)}}let po=null;(function(e,t=!0){(function(i){Jr=i})(Rn),mn(new fn("firestore",(r,{instanceIdentifier:i,options:s})=>{const o=r.getProvider("app").getImmediate(),c=new se(new tE(r.getProvider("auth-internal")),new iE(r.getProvider("app-check-internal")),function(l,d){if(!Object.prototype.hasOwnProperty.apply(l.options,["projectId"]))throw new N(P.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new _n(l.options.projectId,d)}(o,i),o);return s=Object.assign({useFetchStreams:t},s),c._setSettings(s),c},"PUBLIC").setMultipleInstances(!0)),ct(Jh,"4.7.3",e),ct(Jh,"4.7.3","esm2017")})();const we=Object.freeze(Object.defineProperty({__proto__:null,AbstractUserDataWriter:cl,AggregateField:Hr,AggregateQuerySnapshot:yg,Bytes:An,CACHE_SIZE_UNLIMITED:hA,CollectionReference:dt,DocumentReference:ve,DocumentSnapshot:ir,FieldPath:Dn,FieldValue:kn,Firestore:se,FirestoreError:N,GeoPoint:va,LoadBundleTask:mg,PersistentCacheIndexManager:xg,Query:xe,QueryCompositeFilterConstraint:lr,QueryConstraint:si,QueryDocumentSnapshot:Zi,QueryEndAtConstraint:xs,QueryFieldFilterConstraint:oi,QueryLimitConstraint:Vs,QueryOrderByConstraint:Sa,QuerySnapshot:sr,QueryStartAtConstraint:Os,SnapshotMetadata:cn,Timestamp:ge,Transaction:Og,VectorValue:ks,WriteBatch:Vg,_AutoId:du,_ByteString:Ie,_DatabaseId:_n,_DocumentKey:U,_EmptyAppCheckTokenProvider:sE,_EmptyAuthCredentialsProvider:mp,_FieldPath:he,_TestingHooks:VR,_cast:J,_debugAssert:ZT,_internalAggregationQueryToProtoRunAggregationQueryRequest:NR,_internalQueryToProtoQueryTarget:kR,_isBase64Available:VE,_logWarn:it,_validateIsNotUsedTogether:hg,addDoc:nR,aggregateFieldEqual:zA,aggregateQuerySnapshotEqual:GA,and:NA,arrayRemove:vR,arrayUnion:ER,average:jA,clearIndexedDbPersistence:gA,collection:cA,collectionGroup:uA,connectFirestoreEmulator:fg,count:Dg,deleteAllPersistentCacheIndexes:DR,deleteDoc:tR,deleteField:IR,disableNetwork:IA,disablePersistentCacheIndexAutoCreation:CR,doc:pg,documentId:wA,enableIndexedDbPersistence:pA,enableMultiTabIndexedDbPersistence:mA,enableNetwork:yA,enablePersistentCacheIndexAutoCreation:PR,endAt:UA,endBefore:FA,ensureFirestoreConfigured:_e,executeWrite:ai,getAggregateFromServer:kg,getCountFromServer:sR,getDoc:HA,getDocFromCache:WA,getDocFromServer:QA,getDocs:JA,getDocsFromCache:YA,getDocsFromServer:XA,getFirestore:fA,getPersistentCacheIndexManager:SR,increment:wR,initializeFirestore:dA,limit:OA,limitToLast:xA,loadBundle:EA,memoryEagerGarbageCollector:lR,memoryLocalCache:dR,memoryLruGarbageCollector:hR,namedQuery:vA,onSnapshot:rR,onSnapshotsInSync:iR,or:kA,orderBy:VA,persistentLocalCache:fR,persistentMultipleTabManager:gR,persistentSingleTabManager:Ng,query:CA,queryEqual:Zu,refEqual:lA,runTransaction:yR,serverTimestamp:TR,setDoc:ZA,setIndexConfiguration:bR,setLogLevel:XT,snapshotEqual:KA,startAfter:MA,startAt:LA,sum:qA,terminate:TA,updateDoc:eR,vector:AR,waitForPendingWrites:_A,where:DA,writeBatch:RR},Symbol.toStringTag,{value:"Module"}));function hl(n,e){var t={};for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&e.indexOf(r)<0&&(t[r]=n[r]);if(n!=null&&typeof Object.getOwnPropertySymbols=="function")for(var i=0,r=Object.getOwnPropertySymbols(n);i<r.length;i++)e.indexOf(r[i])<0&&Object.prototype.propertyIsEnumerable.call(n,r[i])&&(t[r[i]]=n[r[i]]);return t}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Yo=new uu("@firebase/auth");function jR(n,...e){Yo.logLevel<=Y.WARN&&Yo.warn(`Auth (${Rn}): ${n}`,...e)}function Do(n,...e){Yo.logLevel<=Y.ERROR&&Yo.error(`Auth (${Rn}): ${n}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function nt(n,...e){throw fl(n,...e)}function Xe(n,...e){return fl(n,...e)}function dl(n,e,t){const r=Object.assign(Object.assign({},Fg()),{[e]:t});return new Ts("auth","Firebase",r).create(e,{appName:n.name})}function Oe(n){return dl(n,"operation-not-supported-in-this-environment","Operations that alter the current user are not supported in conjunction with FirebaseServerApp")}function ci(n,e,t){const r=t;if(!(e instanceof r))throw r.name!==e.constructor.name&&nt(n,"argument-error"),dl(n,"argument-error",`Type of ${e.constructor.name} does not match expected instance.Did you pass a reference from a different Auth SDK?`)}function fl(n,...e){if(typeof n!="string"){const t=e[0],r=[...e.slice(1)];return r[0]&&(r[0].appName=n.name),n._errorFactory.create(t,...r)}return Ug.create(n,...e)}function x(n,e,...t){if(!n)throw fl(e,...t)}function It(n){const e="INTERNAL ASSERTION FAILED: "+n;throw Do(e),new Error(e)}function qt(n,e){n||It(e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ms(){var n;return typeof self<"u"&&((n=self.location)===null||n===void 0?void 0:n.href)||""}function pl(){return uf()==="http:"||uf()==="https:"}function uf(){var n;return typeof self<"u"&&((n=self.location)===null||n===void 0?void 0:n.protocol)||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function zR(){return typeof navigator<"u"&&navigator&&"onLine"in navigator&&typeof navigator.onLine=="boolean"&&(pl()||CI()||"connection"in navigator)?navigator.onLine:!0}function GR(){if(typeof navigator>"u")return null;const n=navigator;return n.languages&&n.languages[0]||n.language||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ml(n,e){qt(n.emulator,"Emulator should always be set here");const{url:t}=n.emulator;return e?`${t}${e.startsWith("/")?e.slice(1):e}`:t}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function XR(n,e=!1){return q(n).getIdToken(e)}async function Kg(n,e=!1){const t=q(n),r=await t.getIdToken(e),i=Ca(r);x(i&&i.exp&&i.auth_time&&i.iat,t.auth,"internal-error");const s=typeof i.firebase=="object"?i.firebase:void 0,o=s==null?void 0:s.sign_in_provider;return{claims:i,token:r,authTime:es(vc(i.auth_time)),issuedAtTime:es(vc(i.iat)),expirationTime:es(vc(i.exp)),signInProvider:o||null,signInSecondFactor:(s==null?void 0:s.sign_in_second_factor)||null}}function vc(n){return Number(n)*1e3}function Ca(n){const[e,t,r]=n.split(".");if(e===void 0||t===void 0||r===void 0)return Do("JWT malformed, contained fewer than 3 sections"),null;try{const i=jf(t);return i?JSON.parse(i):(Do("Failed to decode base64 JWT payload"),null)}catch(i){return Do("Caught error parsing JWT payload as JSON",i==null?void 0:i.toString()),null}}function df(n){const e=Ca(n);return x(e,"internal-error"),x(typeof e.exp<"u","internal-error"),x(typeof e.iat<"u","internal-error"),Number(e.exp)-Number(e.iat)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function gs(n){var e;const t=n.auth,r=await n.getIdToken(),i=await jt(n,$g(t,{idToken:r}));x(i==null?void 0:i.users.length,t,"internal-error");const s=i.users[0];n._notifyReloadListener(s);const o=!((e=s.providerUserInfo)===null||e===void 0)&&e.length?Wg(s.providerUserInfo):[],c=tb(n.providerData,o),u=n.isAnonymous,l=!(n.email&&s.passwordHash)&&!(c!=null&&c.length),d=u?l:!1,p={uid:s.localId,displayName:s.displayName||null,photoURL:s.photoUrl||null,email:s.email||null,emailVerified:s.emailVerified||!1,phoneNumber:s.phoneNumber||null,tenantId:s.tenantId||null,providerData:c,metadata:new tu(s.createdAt,s.lastLoginAt),isAnonymous:d};Object.assign(n,p)}async function Hg(n){const e=q(n);await gs(e),await e.auth._persistUserIfCurrent(e),e.auth._notifyListenersIfCurrent(e)}function tb(n,e){return[...n.filter(r=>!e.some(i=>i.providerId===r.providerId)),...e]}function Wg(n){return n.map(e=>{var{providerId:t}=e,r=hl(e,["providerId"]);return{providerId:t,uid:r.rawId||"",displayName:r.displayName||null,email:r.email||null,phoneNumber:r.phoneNumber||null,photoURL:r.photoUrl||null}})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ff=new Map;function xt(n){qt(n instanceof Function,"Expected a class definition");let e=ff.get(n);return e?(qt(e instanceof n,"Instance stored in cache mismatched with class"),e):(e=new n,ff.set(n,e),e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Qg{constructor(){this.type="NONE",this.storage={}}async _isAvailable(){return!0}async _set(e,t){this.storage[e]=t}async _get(e){const t=this.storage[e];return t===void 0?null:t}async _remove(e){delete this.storage[e]}_addListener(e,t){}_removeListener(e,t){}}Qg.type="NONE";const nu=Qg;/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function pf(n){const e=n.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(Zg(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(Jg(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(t_(e))return"Blackberry";if(n_(e))return"Webos";if(Yg(e))return"Safari";if((e.includes("chrome/")||Xg(e))&&!e.includes("edge/"))return"Chrome";if(e_(e))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,r=n.match(t);if((r==null?void 0:r.length)===2)return r[1]}return"Other"}function Jg(n=Ce()){return/firefox\//i.test(n)}function Yg(n=Ce()){const e=n.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function Xg(n=Ce()){return/crios\//i.test(n)}function Zg(n=Ce()){return/iemobile/i.test(n)}function e_(n=Ce()){return/android/i.test(n)}function t_(n=Ce()){return/blackberry/i.test(n)}function n_(n=Ce()){return/webos/i.test(n)}function gl(n=Ce()){return/iphone|ipad|ipod/i.test(n)||/macintosh/i.test(n)&&/mobile/i.test(n)}function ib(n=Ce()){var e;return gl(n)&&!!(!((e=window.navigator)===null||e===void 0)&&e.standalone)}function sb(){return kI()&&document.documentMode===10}function r_(n=Ce()){return gl(n)||e_(n)||n_(n)||t_(n)||/windows phone/i.test(n)||Zg(n)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function i_(n,e=[]){let t;switch(n){case"Browser":t=pf(Ce());break;case"Worker":t=`${pf(Ce())}-${n}`;break;default:t=n}const r=e.length?e.join(","):"FirebaseCore-web";return`${t}/JsCore/${Rn}/${r}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function a_(n,e){const t=ar(n,"auth");if(t.isInitialized()){const i=t.getImmediate(),s=t.getOptions();if(dn(s,e??{}))return i;nt(i,"already-initialized")}return t.initialize({options:e})}function yb(n,e){const t=(e==null?void 0:e.persistence)||[],r=(Array.isArray(t)?t:[t]).map(xt);e!=null&&e.errorMap&&n._updateErrorMap(e.errorMap),n._initializeWithPersistence(r,e==null?void 0:e.popupRedirectResolver)}function c_(n,e,t){const r=Ae(n);x(r._canInitEmulator,r,"emulator-config-failed"),x(/^https?:\/\//.test(e),r,"invalid-emulator-scheme");const i=!!(t!=null&&t.disableWarnings),s=u_(e),{host:o,port:c}=Ib(e),u=c===null?"":`:${c}`;r.config.emulator={url:`${s}//${o}${u}/`},r.settings.appVerificationDisabledForTesting=!0,r.emulatorConfig=Object.freeze({host:o,port:c,protocol:s.replace(":",""),options:Object.freeze({disableWarnings:i})}),i||Tb()}function u_(n){const e=n.indexOf(":");return e<0?"":n.substr(0,e+1)}function Ib(n){const e=u_(n),t=/(\/\/)?([^?#/]+)/.exec(n.substr(e.length));if(!t)return{host:"",port:null};const r=t[2].split("@").pop()||"",i=/^(\[[^\]]+\])(:|$)/.exec(r);if(i){const s=i[1];return{host:s,port:_f(r.substr(s.length+1))}}else{const[s,o]=r.split(":");return{host:s,port:_f(o)}}}function _f(n){if(!n)return null;const e=Number(n);return isNaN(e)?null:e}function Tb(){function n(){const e=document.createElement("p"),t=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",t.position="fixed",t.width="100%",t.backgroundColor="#ffffff",t.border=".1em solid #000000",t.color="#b50000",t.bottom="0px",t.left="0px",t.margin="0px",t.zIndex="10000",t.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",n):n())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ab(n,e){return Ht(n,"POST","/v1/accounts:signInWithPassword",de(n,e))}async function Da(n,e){return fe(n,"POST","/v1/accounts:sendOobCode",de(n,e))}async function Rb(n,e){return Da(n,e)}async function bb(n,e){return Da(n,e)}async function Sb(n,e){return Da(n,e)}async function Pb(n,e){return Da(n,e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Mb(n){switch(n){case"recoverEmail":return"RECOVER_EMAIL";case"resetPassword":return"PASSWORD_RESET";case"signIn":return"EMAIL_SIGNIN";case"verifyEmail":return"VERIFY_EMAIL";case"verifyAndChangeEmail":return"VERIFY_AND_CHANGE_EMAIL";case"revertSecondFactorAddition":return"REVERT_SECOND_FACTOR_ADDITION";default:return null}}function Fb(n){const e=Bi(qi(n)).link,t=e?Bi(qi(e)).deep_link_id:null,r=Bi(qi(n)).deep_link_id;return(r?Bi(qi(r)).link:null)||r||t||e||n}class li{constructor(e){var t,r,i,s,o,c;const u=Bi(qi(e)),l=(t=u.apiKey)!==null&&t!==void 0?t:null,d=(r=u.oobCode)!==null&&r!==void 0?r:null,p=Mb((i=u.mode)!==null&&i!==void 0?i:null);x(l&&d&&p,"argument-error"),this.apiKey=l,this.operation=p,this.code=d,this.continueUrl=(s=u.continueUrl)!==null&&s!==void 0?s:null,this.languageCode=(o=u.languageCode)!==null&&o!==void 0?o:null,this.tenantId=(c=u.tenantId)!==null&&c!==void 0?c:null}static parseLink(e){const t=Fb(e);try{return new li(t)}catch{return null}}}function Ub(n){return li.parseLink(n)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Vn{constructor(){this.providerId=Vn.PROVIDER_ID}static credential(e,t){return Wr._fromEmailAndPassword(e,t)}static credentialWithLink(e,t){const r=li.parseLink(t);return x(r,"argument-error"),Wr._fromEmailAndCode(e,r.code,r.tenantId)}}Vn.PROVIDER_ID="password";Vn.EMAIL_PASSWORD_SIGN_IN_METHOD="password";Vn.EMAIL_LINK_SIGN_IN_METHOD="emailLink";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const qb="saml.";class Xo extends Wt{constructor(e){x(e.startsWith(qb),"argument-error"),super(e)}static credentialFromResult(e){return Xo.samlCredentialFromTaggedObject(e)}static credentialFromError(e){return Xo.samlCredentialFromTaggedObject(e.customData||{})}static credentialFromJSON(e){const t=ys.fromJSON(e);return x(t,"argument-error"),t}static samlCredentialFromTaggedObject({_tokenResponse:e}){if(!e)return null;const{pendingToken:t,providerId:r}=e;if(!t||!r)return null;try{return ys._create(r,t)}catch{return null}}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function zb(n,e){const t=q(n);await ka(!0,t,e);const{providerUserInfo:r}=await YR(t.auth,{idToken:await t.getIdToken(),deleteProvider:[e]}),i=f_(r||[]);return t.providerData=t.providerData.filter(s=>i.has(s.providerId)),i.has("phone")||(t.phoneNumber=null),await t.auth._persistUserIfCurrent(t),t}async function yl(n,e,t=!1){const r=await jt(n,e._linkToIdToken(n.auth,await n.getIdToken()),t);return ut._forOperation(n,"link",r)}async function ka(n,e,t){await gs(e);const r=f_(e.providerData),i=n===!1?"provider-already-linked":"no-such-provider";x(r.has(t)===n,e.auth,i)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function m_(n,e,t=!1){if(Ee(n.app))return Promise.reject(Oe(n));const r="signIn",i=await d_(n,r,e),s=await ut._fromIdTokenResponse(n,r,i);return t||await n._updateCurrentUser(s.user),s}async function Na(n,e){return m_(Ae(n),e)}async function g_(n,e){const t=q(n);return await ka(!1,t,e.providerId),yl(t,e)}async function __(n,e){return p_(q(n),e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Fs{constructor(e,t){this.factorId=e,this.uid=t.mfaEnrollmentId,this.enrollmentTime=new Date(t.enrolledAt).toUTCString(),this.displayName=t.displayName}static _fromServerResponse(e,t){return"phoneInfo"in t?Il._fromServerResponse(e,t):"totpInfo"in t?Tl._fromServerResponse(e,t):nt(e,"internal-error")}}class Il extends Fs{constructor(e){super("phone",e),this.phoneNumber=e.phoneInfo}static _fromServerResponse(e,t){return new Il(t)}}class Tl extends Fs{constructor(e){super("totp",e)}static _fromServerResponse(e,t){return new Tl(t)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function El(n){const e=Ae(n);e._getPasswordPolicyInternal()&&await e._updatePasswordPolicy()}async function Kb(n,e,t){const r=Ae(n),i={requestType:"PASSWORD_RESET",email:e,clientType:"CLIENT_TYPE_WEB"};t&&Va(r,i,t),await _s(r,i,"getOobCode",bb)}async function Hb(n,e,t){await l_(q(n),{oobCode:e,newPassword:t}).catch(async r=>{throw r.code==="auth/password-does-not-meet-requirements"&&El(n),r})}async function Wb(n,e){await wb(q(n),{oobCode:e})}async function y_(n,e){const t=q(n),r=await l_(t,{oobCode:e}),i=r.requestType;switch(x(i,t,"internal-error"),i){case"EMAIL_SIGNIN":break;case"VERIFY_AND_CHANGE_EMAIL":x(r.newEmail,t,"internal-error");break;case"REVERT_SECOND_FACTOR_ADDITION":x(r.mfaInfo,t,"internal-error");default:x(r.email,t,"internal-error")}let s=null;return r.mfaInfo&&(s=Fs._fromServerResponse(Ae(t),r.mfaInfo)),{data:{email:(r.requestType==="VERIFY_AND_CHANGE_EMAIL"?r.newEmail:r.email)||null,previousEmail:(r.requestType==="VERIFY_AND_CHANGE_EMAIL"?r.email:r.newEmail)||null,multiFactorInfo:s},operation:i}}async function Qb(n,e){const{data:t}=await y_(q(n),e);return t.email}async function Jb(n,e,t){if(Ee(n.app))return Promise.reject(Oe(n));const r=Ae(n),o=await _s(r,{returnSecureToken:!0,email:e,password:t,clientType:"CLIENT_TYPE_WEB"},"signUpPassword",h_).catch(u=>{throw u.code==="auth/password-does-not-meet-requirements"&&El(n),u}),c=await ut._fromIdTokenResponse(r,"signIn",o);return await r._updateCurrentUser(c.user),c}function Yb(n,e,t){return Ee(n.app)?Promise.reject(Oe(n)):Na(q(n),Vn.credential(e,t)).catch(async r=>{throw r.code==="auth/password-does-not-meet-requirements"&&El(n),r})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Xb(n,e,t){const r=Ae(n),i={requestType:"EMAIL_SIGNIN",email:e,clientType:"CLIENT_TYPE_WEB"};function s(o,c){x(c.handleCodeInApp,r,"argument-error"),c&&Va(r,o,c)}s(i,t),await _s(r,i,"getOobCode",Sb)}function Zb(n,e){const t=li.parseLink(e);return(t==null?void 0:t.operation)==="EMAIL_SIGNIN"}async function eS(n,e,t){if(Ee(n.app))return Promise.reject(Oe(n));const r=q(n),i=Vn.credentialWithLink(e,t||ms());return x(i._tenantId===(r.tenantId||null),r,"tenant-id-mismatch"),Na(r,i)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function nS(n,e){const t=pl()?ms():"http://localhost",r={identifier:e,continueUri:t},{signinMethods:i}=await tS(q(n),r);return i||[]}async function rS(n,e){const t=q(n),i={requestType:"VERIFY_EMAIL",idToken:await n.getIdToken()};e&&Va(t.auth,i,e);const{email:s}=await Rb(t.auth,i);s!==n.email&&await n.reload()}async function iS(n,e,t){const r=q(n),s={requestType:"VERIFY_AND_CHANGE_EMAIL",idToken:await n.getIdToken(),newEmail:e};t&&Va(r.auth,s,t);const{email:o}=await Pb(r.auth,s);o!==n.email&&await n.reload()}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class vl{constructor(e,t,r){this.session=e,this.hints=t,this.signInResolver=r}static _fromError(e,t){const r=Ae(e),i=t.customData._serverResponse,s=(i.mfaInfo||[]).map(c=>Fs._fromServerResponse(r,c));x(i.mfaPendingCredential,r,"internal-error");const o=Kn._fromMfaPendingCredential(i.mfaPendingCredential);return new vl(o,s,async c=>{const u=await c._process(r,o);delete i.mfaInfo,delete i.mfaPendingCredential;const l=Object.assign(Object.assign({},i),{idToken:u.idToken,refreshToken:u.refreshToken});switch(t.operationType){case"signIn":const d=await ut._fromIdTokenResponse(r,t.operationType,l);return await r._updateCurrentUser(d.user),d;case"reauthenticate":return x(t.user,r,"internal-error"),ut._forOperation(t.user,t.operationType,l);default:nt(r,"internal-error")}})}async resolveSignIn(e){const t=e;return this.signInResolver(t)}}function AS(n,e){var t;const r=q(n),i=e;return x(e.customData.operationType,r,"argument-error"),x((t=i.customData._serverResponse)===null||t===void 0?void 0:t.mfaPendingCredential,r,"argument-error"),vl._fromError(r,i)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class b_ extends w_{constructor(){super(()=>window.sessionStorage,"SESSION")}_addListener(e,t){}_removeListener(e,t){}}b_.type="SESSION";const Al=b_;/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Rl(){return typeof Pe().WorkerGlobalScope<"u"&&typeof Pe().importScripts=="function"}async function LS(){if(!(navigator!=null&&navigator.serviceWorker))return null;try{return(await navigator.serviceWorker.ready).active}catch{return null}}function MS(){var n;return((n=navigator==null?void 0:navigator.serviceWorker)===null||n===void 0?void 0:n.controller)||null}function FS(){return Rl()?self:null}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ac=s_("rcb"),XS=new Ls(3e4,6e4);class ZS{constructor(){var e;this.hostLanguage="",this.counter=0,this.librarySeparatelyLoaded=!!(!((e=Pe().grecaptcha)===null||e===void 0)&&e.render)}load(e,t=""){return x(eP(t),e,"argument-error"),this.shouldResolveImmediately(t)&&lf(Pe().grecaptcha)?Promise.resolve(Pe().grecaptcha):new Promise((r,i)=>{const s=Pe().setTimeout(()=>{i(Xe(e,"network-request-failed"))},XS.get());Pe()[Ac]=()=>{Pe().clearTimeout(s),delete Pe()[Ac];const c=Pe().grecaptcha;if(!c||!lf(c)){i(Xe(e,"internal-error"));return}const u=c.render;c.render=(l,d)=>{const p=u(l,d);return this.counter++,p},this.hostLanguage=t,r(c)};const o=`${db()}?${Qr({onload:Ac,render:"explicit",hl:t})}`;_l(o).catch(()=>{clearTimeout(s),i(Xe(e,"internal-error"))})})}clearedOneInstance(){this.counter--}shouldResolveImmediately(e){var t;return!!(!((t=Pe().grecaptcha)===null||t===void 0)&&t.render)&&(e===this.hostLanguage||this.counter>0||this.librarySeparatelyLoaded)}}function eP(n){return n.length<=6&&/^\s*[a-zA-Z0-9\-]*\s*$/.test(n)}class tP{async load(e){return new QS(e)}clearedOneInstance(){}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const k_="recaptcha",nP={theme:"light",type:"image"};class rP{constructor(e,t,r=Object.assign({},nP)){this.parameters=r,this.type=k_,this.destroyed=!1,this.widgetId=null,this.tokenChangeListeners=new Set,this.renderPromise=null,this.recaptcha=null,this.auth=Ae(e),this.isInvisible=this.parameters.size==="invisible",x(typeof document<"u",this.auth,"operation-not-supported-in-this-environment");const i=typeof t=="string"?document.getElementById(t):t;x(i,this.auth,"argument-error"),this.container=i,this.parameters.callback=this.makeTokenCallback(this.parameters.callback),this._recaptchaLoader=this.auth.settings.appVerificationDisabledForTesting?new tP:new ZS,this.validateStartingState()}async verify(){this.assertNotDestroyed();const e=await this.render(),t=this.getAssertedRecaptcha(),r=t.getResponse(e);return r||new Promise(i=>{const s=o=>{o&&(this.tokenChangeListeners.delete(s),i(o))};this.tokenChangeListeners.add(s),this.isInvisible&&t.execute(e)})}render(){try{this.assertNotDestroyed()}catch(e){return Promise.reject(e)}return this.renderPromise?this.renderPromise:(this.renderPromise=this.makeRenderPromise().catch(e=>{throw this.renderPromise=null,e}),this.renderPromise)}_reset(){this.assertNotDestroyed(),this.widgetId!==null&&this.getAssertedRecaptcha().reset(this.widgetId)}clear(){this.assertNotDestroyed(),this.destroyed=!0,this._recaptchaLoader.clearedOneInstance(),this.isInvisible||this.container.childNodes.forEach(e=>{this.container.removeChild(e)})}validateStartingState(){x(!this.parameters.sitekey,this.auth,"argument-error"),x(this.isInvisible||!this.container.hasChildNodes(),this.auth,"argument-error"),x(typeof document<"u",this.auth,"operation-not-supported-in-this-environment")}makeTokenCallback(e){return t=>{if(this.tokenChangeListeners.forEach(r=>r(t)),typeof e=="function")e(t);else if(typeof e=="string"){const r=Pe()[e];typeof r=="function"&&r(t)}}}assertNotDestroyed(){x(!this.destroyed,this.auth,"internal-error")}async makeRenderPromise(){if(await this.init(),!this.widgetId){let e=this.container;if(!this.isInvisible){const t=document.createElement("div");e.appendChild(t),e=t}this.widgetId=this.getAssertedRecaptcha().render(e,this.parameters)}return this.widgetId}async init(){x(pl()&&!Rl(),this.auth,"internal-error"),await iP(),this.recaptcha=await this._recaptchaLoader.load(this.auth,this.auth.languageCode||void 0);const e=await QR(this.auth);x(e,this.auth,"internal-error"),this.parameters.sitekey=e}getAssertedRecaptcha(){return x(this.recaptcha,this.auth,"internal-error"),this.recaptcha}}function iP(){let n=null;return new Promise(e=>{if(document.readyState==="complete"){e();return}n=()=>e(),window.addEventListener("load",n)}).catch(e=>{throw n&&window.removeEventListener("load",n),e})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bl{constructor(e,t){this.verificationId=e,this.onConfirmation=t}confirm(e){const t=hn._fromVerification(this.verificationId,e);return this.onConfirmation(t)}}async function sP(n,e,t){if(Ee(n.app))return Promise.reject(Oe(n));const r=Ae(n),i=await Ma(r,e,q(t));return new bl(i,s=>Na(r,s))}async function oP(n,e,t){const r=q(n);await ka(!1,r,"phone");const i=await Ma(r.auth,e,q(t));return new bl(i,s=>g_(r,s))}async function aP(n,e,t){const r=q(n);if(Ee(r.auth.app))return Promise.reject(Oe(r.auth));const i=await Ma(r.auth,e,q(t));return new bl(i,s=>__(r,s))}async function Ma(n,e,t){var r;const i=await t.verify();try{x(typeof i=="string",n,"argument-error"),x(t.type===k_,n,"argument-error");let s;if(typeof e=="string"?s={phoneNumber:e}:s=e,"session"in s){const o=s.session;if("phoneNumber"in s)return x(o.type==="enroll",n,"internal-error"),(await RS(n,{idToken:o.credential,phoneEnrollmentInfo:{phoneNumber:s.phoneNumber,recaptchaToken:i}})).phoneSessionInfo.sessionInfo;{x(o.type==="signin",n,"internal-error");const c=((r=s.multiFactorHint)===null||r===void 0?void 0:r.uid)||s.multiFactorUid;return x(c,n,"missing-multi-factor-info"),(await GS(n,{mfaPendingCredential:o.credential,mfaEnrollmentId:c,phoneSignInInfo:{recaptchaToken:i}})).phoneResponseInfo.sessionInfo}}else{const{sessionInfo:o}=await Nb(n,{phoneNumber:s.phoneNumber,recaptchaToken:i});return o}}finally{t._reset()}}async function cP(n,e){const t=q(n);if(Ee(t.auth.app))return Promise.reject(Oe(t.auth));await yl(t,e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Sl extends ui{constructor(e){super("custom","custom"),this.params=e}_getIdTokenResponse(e){return Mt(e,this._buildIdpRequest())}_linkToIdToken(e,t){return Mt(e,this._buildIdpRequest(t))}_getReauthenticationResolver(e){return Mt(e,this._buildIdpRequest())}_buildIdpRequest(e){const t={requestUri:this.params.requestUri,sessionId:this.params.sessionId,postBody:this.params.postBody,tenantId:this.params.tenantId,pendingToken:this.params.pendingToken,returnSecureToken:!0,returnIdpCredential:!0};return e&&(t.idToken=e),t}}function uP(n){return m_(n.auth,new Sl(n),n.bypassAuthState)}function lP(n){const{auth:e,user:t}=n;return x(t,e,"internal-error"),p_(t,new Sl(n),n.bypassAuthState)}async function hP(n){const{auth:e,user:t}=n;return x(t,e,"internal-error"),yl(t,new Sl(n),n.bypassAuthState)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function TP(n,e,t){return EP(n,e,t)}async function EP(n,e,t){if(Ee(n.app))return Promise.reject(Oe(n));const r=Ae(n);ci(n,e,Wt),await r._initializationPromise;const i=hr(r,t);return await Pl(i,r),i._openRedirect(r,e,"signInViaRedirect")}function vP(n,e,t){return wP(n,e,t)}async function wP(n,e,t){const r=q(n);if(ci(r.auth,e,Wt),Ee(r.auth.app))return Promise.reject(Oe(r.auth));await r.auth._initializationPromise;const i=hr(r.auth,t);await Pl(i,r.auth);const s=await L_(r);return i._openRedirect(r.auth,e,"reauthViaRedirect",s)}function AP(n,e,t){return RP(n,e,t)}async function RP(n,e,t){const r=q(n);ci(r.auth,e,Wt),await r.auth._initializationPromise;const i=hr(r.auth,t);await ka(!1,r,e.providerId),await Pl(i,r.auth);const s=await L_(r);return i._openRedirect(r.auth,e,"linkViaRedirect",s)}async function bP(n,e){return await Ae(n)._initializationPromise,x_(n,e,!1)}async function x_(n,e,t=!1){if(Ee(n.app))return Promise.reject(Oe(n));const r=Ae(n),i=hr(r,e),o=await new _P(r,i,t).execute();return o&&!t&&(delete o.user._redirectEventId,await r._persistUserIfCurrent(o.user),await r._setRedirectUser(null,e)),o}async function L_(n){const e=xa(`${n.uid}:::`);return n._redirectEventId=e,await n.auth._setRedirectUser(n),await n.auth._persistUserIfCurrent(n),e}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const xP=new Ls(3e4,6e4);function vf(){const n=Pe().___jsl;if(n!=null&&n.H){for(const e of Object.keys(n.H))if(n.H[e].r=n.H[e].r||[],n.H[e].L=n.H[e].L||[],n.H[e].r=[...n.H[e].L],n.CP)for(let t=0;t<n.CP.length;t++)n.CP[t]=null}}function LP(n){return new Promise((e,t)=>{var r,i,s;function o(){vf(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{vf(),t(Xe(n,"network-request-failed"))},timeout:xP.get()})}if(!((i=(r=Pe().gapi)===null||r===void 0?void 0:r.iframes)===null||i===void 0)&&i.Iframe)e(gapi.iframes.getContext());else if(!((s=Pe().gapi)===null||s===void 0)&&s.load)o();else{const c=s_("iframefcb");return Pe()[c]=()=>{gapi.load?o():t(Xe(n,"network-request-failed"))},_l(`${pb()}?onload=${c}`).catch(u=>t(u))}}).catch(e=>{throw Vo=null,e})}let Vo=null;function MP(n){return Vo=Vo||LP(n),Vo}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const $P={location:"yes",resizable:"yes",statusbar:"yes",toolbar:"no"},KP=500,HP=600,WP="_blank",QP="http://localhost";class wf{constructor(e){this.window=e,this.associatedEvent=null}close(){if(this.window)try{this.window.close()}catch{}}}function JP(n,e,t,r=KP,i=HP){const s=Math.max((window.screen.availHeight-i)/2,0).toString(),o=Math.max((window.screen.availWidth-r)/2,0).toString();let c="";const u=Object.assign(Object.assign({},$P),{width:r.toString(),height:i.toString(),top:s,left:o}),l=Ce().toLowerCase();t&&(c=Xg(l)?WP:t),Jg(l)&&(e=e||QP,u.scrollbars="yes");const d=Object.entries(u).reduce((g,[T,S])=>`${g}${T}=${S},`,"");if(ib(l)&&c!=="_self")return YP(e||"",c),new wf(null);const p=window.open(e||"",c,d);x(p,n,"popup-blocked");try{p.focus()}catch{}return new wf(p)}function YP(n,e){const t=document.createElement("a");t.href=n,t.target=e;const r=document.createEvent("MouseEvent");r.initMouseEvent("click",!0,!0,window,1,0,0,0,0,!1,!1,!1,!1,1,null),t.dispatchEvent(r)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const XP="__/auth/handler",ZP="emulator/auth/handler",eC=encodeURIComponent("fac");async function Af(n,e,t,r,i,s){x(n.config.authDomain,n,"auth-domain-config-required"),x(n.config.apiKey,n,"invalid-api-key");const o={apiKey:n.config.apiKey,appName:n.name,authType:t,redirectUrl:r,v:Rn,eventId:i};if(e instanceof Wt){e.setDefaultLanguage(n.languageCode),o.providerId=e.providerId||"",LI(e.getCustomParameters())||(o.customParameters=JSON.stringify(e.getCustomParameters()));for(const[d,p]of Object.entries({}))o[d]=p}if(e instanceof hi){const d=e.getScopes().filter(p=>p!=="");d.length>0&&(o.scopes=d.join(","))}n.tenantId&&(o.tid=n.tenantId);const c=o;for(const d of Object.keys(c))c[d]===void 0&&delete c[d];const u=await n._getAppCheckToken(),l=u?`#${eC}=${encodeURIComponent(u)}`:"";return`${tC(n)}?${Qr(c).slice(1)}${l}`}function tC({config:n}){return n.emulator?ml(n,ZP):`https://${n.authDomain}/${XP}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Rc="webStorageSupport";class nC{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=Al,this._completeRedirectFn=x_,this._overrideRedirectResult=IP}async _openPopup(e,t,r,i){var s;qt((s=this.eventManagers[e._key()])===null||s===void 0?void 0:s.manager,"_initialize() not called before _openPopup()");const o=await Af(e,t,r,ms(),i);return JP(e,o,xa())}async _openRedirect(e,t,r,i){await this._originValidation(e);const s=await Af(e,t,r,ms(),i);return xS(s),new Promise(()=>{})}_initialize(e){const t=e._key();if(this.eventManagers[t]){const{manager:i,promise:s}=this.eventManagers[t];return i?Promise.resolve(i):(qt(s,"If manager is not set, promise should be"),s)}const r=this.initAndGetManager(e);return this.eventManagers[t]={promise:r},r.catch(()=>{delete this.eventManagers[t]}),r}async initAndGetManager(e){const t=await GP(e),r=new PP(e);return t.register("authEvent",i=>(x(i==null?void 0:i.authEvent,e,"invalid-auth-event"),{status:r.onEvent(i.authEvent)?"ACK":"ERROR"}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:r},this.iframes[e._key()]=t,r}_isIframeWebStorageSupported(e,t){this.iframes[e._key()].send(Rc,{type:Rc},i=>{var s;const o=(s=i==null?void 0:i[0])===null||s===void 0?void 0:s[Rc];o!==void 0&&t(!!o),nt(e,"internal-error")},gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const t=e._key();return this.originValidationPromises[t]||(this.originValidationPromises[t]=VP(e)),this.originValidationPromises[t]}get _shouldInitProactively(){return r_()||Yg()||gl()}}const F_=nC;class U_{constructor(e){this.factorId=e}_process(e,t,r){switch(t.type){case"enroll":return this._finalizeEnroll(e,t.credential,r);case"signin":return this._finalizeSignIn(e,t.credential);default:return It("unexpected MultiFactorSessionType")}}}class Cl extends U_{constructor(e){super("phone"),this.credential=e}static _fromCredential(e){return new Cl(e)}_finalizeEnroll(e,t,r){return bS(e,{idToken:t,displayName:r,phoneVerificationInfo:this.credential._makeVerificationRequest()})}_finalizeSignIn(e,t){return $S(e,{mfaPendingCredential:t,phoneVerificationInfo:this.credential._makeVerificationRequest()})}}class B_{constructor(){}static assertion(e){return Cl._fromCredential(e)}}B_.FACTOR_ID="phone";class q_{static assertionForEnrollment(e,t){return Is._fromSecret(e,t)}static assertionForSignIn(e,t){return Is._fromEnrollmentId(e,t)}static async generateSecret(e){var t;const r=e;x(typeof((t=r.user)===null||t===void 0?void 0:t.auth)<"u","internal-error");const i=await SS(r.user.auth,{idToken:r.credential,totpEnrollmentInfo:{}});return Fa._fromStartTotpMfaEnrollmentResponse(i,r.user.auth)}}q_.FACTOR_ID="totp";class Is extends U_{constructor(e,t,r){super("totp"),this.otp=e,this.enrollmentId=t,this.secret=r}static _fromSecret(e,t){return new Is(t,void 0,e)}static _fromEnrollmentId(e,t){return new Is(t,e)}async _finalizeEnroll(e,t,r){return x(typeof this.secret<"u",e,"argument-error"),PS(e,{idToken:t,displayName:r,totpVerificationInfo:this.secret._makeTotpVerificationInfo(this.otp)})}async _finalizeSignIn(e,t){x(this.enrollmentId!==void 0&&this.otp!==void 0,e,"argument-error");const r={verificationCode:this.otp};return KS(e,{mfaPendingCredential:t,mfaEnrollmentId:this.enrollmentId,totpVerificationInfo:r})}}class Fa{constructor(e,t,r,i,s,o,c){this.sessionInfo=o,this.auth=c,this.secretKey=e,this.hashingAlgorithm=t,this.codeLength=r,this.codeIntervalSeconds=i,this.enrollmentCompletionDeadline=s}static _fromStartTotpMfaEnrollmentResponse(e,t){return new Fa(e.totpSessionInfo.sharedSecretKey,e.totpSessionInfo.hashingAlgorithm,e.totpSessionInfo.verificationCodeLength,e.totpSessionInfo.periodSec,new Date(e.totpSessionInfo.finalizeEnrollmentTime).toUTCString(),e.totpSessionInfo.sessionInfo,t)}_makeTotpVerificationInfo(e){return{sessionInfo:this.sessionInfo,verificationCode:e}}generateQrCodeUrl(e,t){var r;let i=!1;return(go(e)||go(t))&&(i=!0),i&&(go(e)&&(e=((r=this.auth.currentUser)===null||r===void 0?void 0:r.email)||"unknownuser"),go(t)&&(t=this.auth.name)),`otpauth://totp/${t}:${e}?secret=${this.secretKey}&issuer=${t}&algorithm=${this.hashingAlgorithm}&digits=${this.codeLength}`}}function go(n){return typeof n>"u"||(n==null?void 0:n.length)===0}var Rf="@firebase/auth",bf="1.7.9";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function kC(n){return n!==void 0}function NC(n){return typeof n=="function"}function VC(n){return typeof n=="object"&&!Array.isArray(n)}function Ua(n){return typeof n=="string"||n instanceof String}function Pf(n){return kl()&&n instanceof Blob}function kl(){return typeof Blob<"u"}function iu(n,e,t,r){if(r<e)throw na(`Invalid value for '${n}'. Expected ${e} or greater.`);if(r>t)throw na(`Invalid value for '${n}'. Expected ${t} or less.`)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gt{constructor(e,t){let r=0,i="";Pf(e)?(this.data_=e,r=e.size,i=e.type):e instanceof ArrayBuffer?(t?this.data_=new Uint8Array(e):(this.data_=new Uint8Array(e.byteLength),this.data_.set(new Uint8Array(e))),r=this.data_.length):e instanceof Uint8Array&&(t?this.data_=e:(this.data_=new Uint8Array(e.length),this.data_.set(e)),r=e.length),this.size_=r,this.type_=i}size(){return this.size_}type(){return this.type_}slice(e,t){if(Pf(this.data_)){const r=this.data_,i=jC(r,e,t);return i===null?null:new gt(i)}else{const r=new Uint8Array(this.data_.buffer,e,t-e);return new gt(r,!0)}}static getBlob(...e){if(kl()){const t=e.map(r=>r instanceof gt?r.data_:r);return new gt(qC.apply(null,t))}else{const t=e.map(o=>Ua(o)?Nl(ot.RAW,o).data:o.data_);let r=0;t.forEach(o=>{r+=o.byteLength});const i=new Uint8Array(r);let s=0;return t.forEach(o=>{for(let c=0;c<o.length;c++)i[s++]=o[c]}),new gt(i,!0)}}uploadData(){return this.data_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Vl(n){let e;try{e=JSON.parse(n)}catch{return null}return VC(e)?e:null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Cf="prefixes",Df="items";function t0(n,e,t){const r={prefixes:[],items:[],nextPageToken:t.nextPageToken};if(t[Cf])for(const i of t[Cf]){const s=i.replace(/\/$/,""),o=n._makeStorageReference(new $e(e,s));r.prefixes.push(o)}if(t[Df])for(const i of t[Df]){const s=n._makeStorageReference(new $e(e,i.name));r.items.push(s)}return r}function n0(n,e,t){const r=Vl(t);return r===null?null:t0(n,e,r)}class Rt{constructor(e,t,r,i){this.url=e,this.method=t,this.handler=r,this.timeout=i,this.urlParams={},this.headers={},this.body=null,this.errorHandler=null,this.progressCallback=null,this.successCodes=[200],this.additionalRetryCodes=[]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function vt(n){if(!n)throw Dl()}function Ba(n,e){function t(r,i){const s=ny(n,i,e);return vt(s!==null),s}return t}function r0(n,e){function t(r,i){const s=n0(n,e,i);return vt(s!==null),s}return t}function i0(n,e){function t(r,i){const s=ny(n,i,e);return vt(s!==null),e0(s,i,n.host,n._protocol)}return t}function di(n){function e(t,r){let i;return t.getStatus()===401?t.getErrorText().includes("Firebase App Check token is invalid")?i=TC():i=IC():t.getStatus()===402?i=yC(n.bucket):t.getStatus()===403?i=EC(n.path):i=r,i.status=t.getStatus(),i.serverResponse=r.serverResponse,i}return e}function qs(n){const e=di(n);function t(r,i){let s=e(r,i);return r.getStatus()===404&&(s=_C(n.path)),s.serverResponse=i.serverResponse,s}return t}function ry(n,e,t){const r=e.fullServerUrl(),i=Qt(r,n.host,n._protocol),s="GET",o=n.maxOperationRetryTime,c=new Rt(i,s,Ba(n,t),o);return c.errorHandler=qs(e),c}function s0(n,e,t,r,i){const s={};e.isRoot?s.prefix="":s.prefix=e.path+"/",t.length>0&&(s.delimiter=t),r&&(s.pageToken=r),i&&(s.maxResults=i);const o=e.bucketOnlyServerUrl(),c=Qt(o,n.host,n._protocol),u="GET",l=n.maxOperationRetryTime,d=new Rt(c,u,r0(n,e.bucket),l);return d.urlParams=s,d.errorHandler=di(e),d}function iy(n,e,t){const r=e.fullServerUrl(),i=Qt(r,n.host,n._protocol)+"?alt=media",s="GET",o=n.maxOperationRetryTime,c=new Rt(i,s,(u,l)=>l,o);return c.errorHandler=qs(e),t!==void 0&&(c.headers.Range=`bytes=0-${t}`,c.successCodes=[200,206]),c}function o0(n,e,t){const r=e.fullServerUrl(),i=Qt(r,n.host,n._protocol),s="GET",o=n.maxOperationRetryTime,c=new Rt(i,s,i0(n,t),o);return c.errorHandler=qs(e),c}function a0(n,e,t,r){const i=e.fullServerUrl(),s=Qt(i,n.host,n._protocol),o="PATCH",c=Ol(t,r),u={"Content-Type":"application/json; charset=utf-8"},l=n.maxOperationRetryTime,d=new Rt(s,o,Ba(n,r),l);return d.headers=u,d.body=c,d.errorHandler=qs(e),d}function c0(n,e){const t=e.fullServerUrl(),r=Qt(t,n.host,n._protocol),i="DELETE",s=n.maxOperationRetryTime;function o(u,l){}const c=new Rt(r,i,o,s);return c.successCodes=[200,204],c.errorHandler=qs(e),c}function u0(n,e){return n&&n.contentType||e&&e.type()||"application/octet-stream"}function sy(n,e,t){const r=Object.assign({},t);return r.fullPath=n.path,r.size=e.size(),r.contentType||(r.contentType=u0(null,e)),r}function oy(n,e,t,r,i){const s=e.bucketOnlyServerUrl(),o={"X-Goog-Upload-Protocol":"multipart"};function c(){let O="";for(let G=0;G<2;G++)O=O+Math.random().toString().slice(2);return O}const u=c();o["Content-Type"]="multipart/related; boundary="+u;const l=sy(e,r,i),d=Ol(l,t),p="--"+u+`\r
...
\r
`,g=`\r
--`+u+"--",T=gt.getBlob(p,r,g);if(T===null)throw H_();const S={name:l.fullPath},k=Qt(s,n.host,n._protocol),C="POST",B=n.maxUploadRetryTime,M=new Rt(k,C,Ba(n,t),B);return M.urlParams=S,M.headers=o,M.body=T.uploadData(),M.errorHandler=di(e),M}class ra{constructor(e,t,r,i){this.current=e,this.total=t,this.finalized=!!r,this.metadata=i||null}}function xl(n,e){let t=null;try{t=n.getResponseHeader("X-Goog-Upload-Status")}catch{vt(!1)}return vt(!!t&&(e||["active"]).indexOf(t)!==-1),t}function l0(n,e,t,r,i){const s=e.bucketOnlyServerUrl(),o=sy(e,r,i),c={name:o.fullPath},u=Qt(s,n.host,n._protocol),l="POST",d={"X-Goog-Upload-Protocol":"resumable","X-Goog-Upload-Command":"start","X-Goog-Upload-Header-Content-Length":`${r.size()}`,"X-Goog-Upload-Header-Content-Type":o.contentType,"Content-Type":"application/json; charset=utf-8"},p=Ol(o,t),g=n.maxUploadRetryTime;function T(k){xl(k);let C;try{C=k.getResponseHeader("X-Goog-Upload-URL")}catch{vt(!1)}return vt(Ua(C)),C}const S=new Rt(u,l,T,g);return S.urlParams=c,S.headers=d,S.body=p,S.errorHandler=di(e),S}function h0(n,e,t,r){const i={"X-Goog-Upload-Command":"query"};function s(l){const d=xl(l,["active","final"]);let p=null;try{p=l.getResponseHeader("X-Goog-Upload-Size-Received")}catch{vt(!1)}p||vt(!1);const g=Number(p);return vt(!isNaN(g)),new ra(g,r.size(),d==="final")}const o="POST",c=n.maxUploadRetryTime,u=new Rt(t,o,s,c);return u.headers=i,u.errorHandler=di(e),u}const kf=256*1024;function d0(n,e,t,r,i,s,o,c){const u=new ra(0,0);if(o?(u.current=o.current,u.total=o.total):(u.current=0,u.total=r.size()),r.size()!==u.total)throw RC();const l=u.total-u.current;let d=l;i>0&&(d=Math.min(d,i));const p=u.current,g=p+d;let T="";d===0?T="finalize":l===d?T="upload, finalize":T="upload";const S={"X-Goog-Upload-Command":T,"X-Goog-Upload-Offset":`${u.current}`},k=r.slice(p,g);if(k===null)throw H_();function C(G,W){const $=xl(G,["active","final"]),E=u.current+d,_=r.size();let y;return $==="final"?y=Ba(e,s)(G,W):y=null,new ra(E,_,$==="final",y)}const B="POST",M=e.maxUploadRetryTime,O=new Rt(t,B,C,M);return O.headers=S,O.body=k.uploadData(),O.progressCallback=c||null,O.errorHandler=di(n),O}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const f0={STATE_CHANGED:"state_changed"},Ye={RUNNING:"running",PAUSED:"paused",SUCCESS:"success",CANCELED:"canceled",ERROR:"error"};function Pc(n){switch(n){case"running":case"pausing":case"canceling":return Ye.RUNNING;case"paused":return Ye.PAUSED;case"success":return Ye.SUCCESS;case"canceled":return Ye.CANCELED;case"error":return Ye.ERROR;default:return Ye.ERROR}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function C0(n){return/^[A-Za-z]+:\/\//.test(n)}function D0(n,e){return new or(n,e)}function dy(n,e){if(n instanceof Ml){const t=n;if(t._bucket==null)throw AC();const r=new or(t,t._bucket);return e!=null?dy(r,e):r}else return e!==void 0?hy(n,e):n}function k0(n,e){if(e&&C0(e)){if(n instanceof Ml)return D0(n,e);throw na("To use ref(service, url), the first argument must be a Storage instance.")}else return dy(n,e)}function Nf(n,e){const t=e==null?void 0:e[G_];return t==null?null:$e.makeFromBucketSpec(t,n)}function N0(n,e,t,r={}){n.host=`${e}:${t}`,n._protocol="http";const{mockUserToken:i}=r;i&&(n._overrideAuthToken=typeof i=="string"?i:Hf(i,n.app.options.projectId))}class Ml{constructor(e,t,r,i,s){this.app=e,this._authProvider=t,this._appCheckProvider=r,this._url=i,this._firebaseVersion=s,this._bucket=null,this._host=z_,this._protocol="https",this._appId=null,this._deleted=!1,this._maxOperationRetryTime=pC,this._maxUploadRetryTime=mC,this._requests=new Set,i!=null?this._bucket=$e.makeFromBucketSpec(i,this._host):this._bucket=Nf(this._host,this.app.options)}get host(){return this._host}set host(e){this._host=e,this._url!=null?this._bucket=$e.makeFromBucketSpec(this._url,e):this._bucket=Nf(e,this.app.options)}get maxUploadRetryTime(){return this._maxUploadRetryTime}set maxUploadRetryTime(e){iu("time",0,Number.POSITIVE_INFINITY,e),this._maxUploadRetryTime=e}get maxOperationRetryTime(){return this._maxOperationRetryTime}set maxOperationRetryTime(e){iu("time",0,Number.POSITIVE_INFINITY,e),this._maxOperationRetryTime=e}async _getAuthToken(){if(this._overrideAuthToken)return this._overrideAuthToken;const e=this._authProvider.getImmediate({optional:!0});if(e){const t=await e.getToken();if(t!==null)return t.accessToken}return null}async _getAppCheckToken(){const e=this._appCheckProvider.getImmediate({optional:!0});return e?(await e.getToken()).token:null}_delete(){return this._deleted||(this._deleted=!0,this._requests.forEach(e=>e.cancel()),this._requests.clear()),Promise.resolve()}_makeStorageReference(e){return new or(this,e)}_makeRequest(e,t,r,i,s=!0){if(this._deleted)return new PC(W_());{const o=UC(e,this._appId,r,i,t,this._firebaseVersion,s);return this._requests.add(o),o.getPromise().then(()=>this._requests.delete(o),()=>this._requests.delete(o)),o}}async makeRequestWithTokens(e,t){const[r,i]=await Promise.all([this._getAuthToken(),this._getAppCheckToken()]);return this._makeRequest(e,t,r,i).getPromise()}}const Vf="@firebase/storage",Of="0.13.2";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
